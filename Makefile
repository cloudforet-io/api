TARGET = sample core identity repository plugin secret inventory monitoring statistics config report power_scheduler cost_saving billing spot_automation
VERSION = v1
