...
// UnimplementedAccountCollectorServer must be embedded to have
...
func (UnimplementedAccountCollectorServer) testEmbeddedByValue()                          {}
...
func RegisterAccountCollectorServer(s grpc.ServiceRegistrar, srv AccountCollectorServer) {
	// If the following call pancis, it indicates UnimplementedAccountCollectorServer was
