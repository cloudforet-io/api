...
type MyWorkspaceInfo struct {
	...
	RoleType     MyWorkspaceInfo_RoleType `protobuf:"varint,8,opt,name=role_type,json=roleType,proto3,enum=spaceone.api.identity.v2.MyWorkspaceInfo_RoleType" json:"role_type,omitempty"`
	DomainId     string                   `protobuf:"bytes,21,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
...
var file_spaceone_api_identity_v2_user_profile_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x65, 0x12, 0x2b, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x04, 0x20, 0x01,
	...
	0x65, 0x64, 0x12, 0x4f, 0x0a, 0x09, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x32, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65,
...
var file_spaceone_api_identity_v2_user_profile_proto_depIdxs = []int32{
	...
	12, // 3: spaceone.api.identity.v2.MyWorkspaceInfo.tags:type_name -> google.protobuf.Struct
	1,  // 4: spaceone.api.identity.v2.MyWorkspaceInfo.role_type:type_name -> spaceone.api.identity.v2.MyWorkspaceInfo.RoleType
