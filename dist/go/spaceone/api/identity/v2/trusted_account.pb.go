...
var file_spaceone_api_identity_v2_trusted_account_proto_rawDesc = string([]byte{
...
var (
	...
	file_spaceone_api_identity_v2_trusted_account_proto_rawDescData []byte
)
...
func file_spaceone_api_identity_v2_trusted_account_proto_rawDescGZIP() []byte {
	file_spaceone_api_identity_v2_trusted_account_proto_rawDescOnce.Do(func() {
		file_spaceone_api_identity_v2_trusted_account_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_identity_v2_trusted_account_proto_rawDesc), len(file_spaceone_api_identity_v2_trusted_account_proto_rawDesc)))
	})
...
func file_spaceone_api_identity_v2_trusted_account_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_identity_v2_trusted_account_proto_rawDesc), len(file_spaceone_api_identity_v2_trusted_account_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
