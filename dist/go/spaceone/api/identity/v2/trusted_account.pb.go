...
const file_spaceone_api_identity_v2_trusted_account_proto_rawDesc = "" +
	"\n" +
	".spaceone/api/identity/v2/trusted_account.proto\x12\x18spaceone.api.identity.v2\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\x1a\"spaceone/api/identity/v2/job.proto\"\xa2\x01\n" +
	"\tScheduled\x12H\n" +
	"\x05state\x18\x01 \x01(\x0e22.spaceone.api.identity.v2.Scheduled.ScheduledStateR\x05state\x12\x14\n" +
	"\x05hours\x18\x02 \x03(\x05R\x05hours\"5\n" +
	"\x0eScheduledState\x12\b\n" +
	"\x04NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\"\x8d\x05\n" +
	"\x1bCreateTrustedAccountRequest\x12\x12\n" +
	...
	"secretData\x12?\n" +
	"\bschedule\x18\x06 \x01(\v2#.spaceone.api.identity.v2.ScheduledR\bschedule\x12:\n" +
	"\fsync_options\x18\a \x01(\v2\x17.google.protobuf.StructR\vsyncOptions\x12>\n" +
	"\x0eplugin_options\x18\b \x01(\v2\x17.google.protobuf.StructR\rpluginOptions\x12+\n" +
	"\x04tags\x18\t \x01(\v2\x17.google.protobuf.StructR\x04tags\x12j\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e2C.spaceone.api.identity.v2.CreateTrustedAccountRequest.ResourceGroupR\rresourceGroup\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\"4\n" +
	"\rResourceGroup\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06DOMAIN\x10\x01\x12\r\n" +
	"\tWORKSPACE\x10\x02\"\xf6\x02\n" +
	"\x1bUpdateTrustedAccountRequest\x12,\n" +
	"\x12trusted_account_id\x18\x01 \x01(\tR\x10trustedAccountId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12+\n" +
	"\x04data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x04data\x12?\n" +
	"\bschedule\x18\x04 \x01(\v2#.spaceone.api.identity.v2.ScheduledR\bschedule\x12:\n" +
	"\fsync_options\x18\x05 \x01(\v2\x17.google.protobuf.StructR\vsyncOptions\x12>\n" +
	"\x0eplugin_options\x18\x06 \x01(\v2\x17.google.protobuf.StructR\rpluginOptions\x12+\n" +
	"\x04tags\x18\a \x01(\v2\x17.google.protobuf.StructR\x04tags\"\xb5\x01\n" +
	"!UpdateTrustedAccountSecretRequest\x12,\n" +
	"\x12trusted_account_id\x18\x01 \x01(\tR\x10trustedAccountId\x12(\n" +
	"\x10secret_schema_id\x18\x02 \x01(\tR\x0esecretSchemaId\x128\n" +
	"\vsecret_data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\n" +
	"secretData\"E\n" +
	"\x15TrustedAccountRequest\x12,\n" +
	"\x12trusted_account_id\x18\x01 \x01(\tR\x10trustedAccountId\"\xd7\x05\n" +
	"\x12TrustedAccountInfo\x12,\n" +
	"\x12trusted_account_id\x18\x01 \x01(\tR\x10trustedAccountId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12+\n" +
	"\x04data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x04data\x12\x1a\n" +
	"\bprovider\x18\x04 \x01(\tR\bprovider\x12?\n" +
	"\bschedule\x18\x05 \x01(\v2#.spaceone.api.identity.v2.ScheduledR\bschedule\x12:\n" +
	"\fsync_options\x18\x06 \x01(\v2\x17.google.protobuf.StructR\vsyncOptions\x12>\n" +
	"\x0eplugin_options\x18\a \x01(\v2\x17.google.protobuf.StructR\rpluginOptions\x12+\n" +
	"\x04tags\x18\b \x01(\v2\x17.google.protobuf.StructR\x04tags\x12a\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e2:.spaceone.api.identity.v2.TrustedAccountInfo.ResourceGroupR\rresourceGroup\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\x12!\n" +
	"\fworkspace_id\x18\x16 \x01(\tR\vworkspaceId\x12(\n" +
	"\x10secret_schema_id\x18\x17 \x01(\tR\x0esecretSchemaId\x12*\n" +
	"\x11trusted_secret_id\x18\x18 \x01(\tR\x0ftrustedSecretId\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"\x06DOMAIN\x10\x01\x12\r\n" +
	"\tWORKSPACE\x10\x02\"\xdb\x02\n" +
	"\x19TrustedAccountSearchQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12,\n" +
	"\x12trusted_account_id\x18\x02 \x01(\tR\x10trustedAccountId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1a\n" +
	"\bprovider\x18\x04 \x01(\tR\bprovider\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\x12(\n" +
	"\x10secret_schema_id\x18\x16 \x01(\tR\x0esecretSchemaId\x12*\n" +
	"\x11trusted_secret_id\x18\x17 \x01(\tR\x0ftrustedSecretId\"4\n" +
	"\rResourceGroup\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06DOMAIN\x10\x01\x12\r\n" +
	"\tWORKSPACE\x10\x02\"~\n" +
	"\x13TrustedAccountsInfo\x12F\n" +
	"\aresults\x18\x01 \x03(\v2,.spaceone.api.identity.v2.TrustedAccountInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"V\n" +
	"\x17TrustedAccountStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xcf\t\n" +
	"\x0eTrustedAccount\x12\x9d\x01\n" +
	"\x06create\x125.spaceone.api.identity.v2.CreateTrustedAccountRequest\x1a,.spaceone.api.identity.v2.TrustedAccountInfo\".\x82\xd3\xe4\x93\x02(:\x01*\"#/identity/v2/trusted-account/create\x12\x9d\x01\n" +
	"\x06update\x125.spaceone.api.identity.v2.UpdateTrustedAccountRequest\x1a,.spaceone.api.identity.v2.TrustedAccountInfo\".\x82\xd3\xe4\x93\x02(:\x01*\"#/identity/v2/trusted-account/update\x12\xbb\x01\n" +
	"\x12update_secret_data\x12;.spaceone.api.identity.v2.UpdateTrustedAccountSecretRequest\x1a,.spaceone.api.identity.v2.TrustedAccountInfo\":\x82\xd3\xe4\x93\x024:\x01*\"//identity/v2/trusted-account/update-secret-data\x12\x81\x01\n" +
	"\x06delete\x12/.spaceone.api.identity.v2.TrustedAccountRequest\x1a\x16.google.protobuf.Empty\".\x82\xd3\xe4\x93\x02(:\x01*\"#/identity/v2/trusted-account/delete\x12\x88\x01\n" +
	"\x04sync\x12/.spaceone.api.identity.v2.TrustedAccountRequest\x1a!.spaceone.api.identity.v2.JobInfo\",\x82\xd3\xe4\x93\x02&:\x01*\"!/identity/v2/trusted-account/sync\x12\x91\x01\n" +
	"\x03get\x12/.spaceone.api.identity.v2.TrustedAccountRequest\x1a,.spaceone.api.identity.v2.TrustedAccountInfo\"+\x82\xd3\xe4\x93\x02%:\x01*\" /identity/v2/trusted-account/get\x12\x98\x01\n" +
	"\x04list\x123.spaceone.api.identity.v2.TrustedAccountSearchQuery\x1a-.spaceone.api.identity.v2.TrustedAccountsInfo\",\x82\xd3\xe4\x93\x02&:\x01*\"!/identity/v2/trusted-account/list\x12\x80\x01\n" +
	"\x04stat\x121.spaceone.api.identity.v2.TrustedAccountStatQuery\x1a\x17.google.protobuf.Struct\",\x82\xd3\xe4\x93\x02&:\x01*\"!/identity/v2/trusted-account/statB?Z=github.com/cloudforet-io/api/dist/go/spaceone/api/identity/v2b\x06proto3"
