...
type CreateTrustedAccountRequest_Scope int32

const (
	CreateTrustedAccountRequest_NONE      CreateTrustedAccountRequest_Scope = 0
	CreateTrustedAccountRequest_DOMAIN    CreateTrustedAccountRequest_Scope = 1
	CreateTrustedAccountRequest_WORKSPACE CreateTrustedAccountRequest_Scope = 2
)

// Enum value maps for CreateTrustedAccountRequest_Scope.
var (
	CreateTrustedAccountRequest_Scope_name = map[int32]string{
		0: "NONE",
		1: "DOMAIN",
		2: "WORKSPACE",
	}
	CreateTrustedAccountRequest_Scope_value = map[string]int32{
		"NONE":      0,
		"DOMAIN":    1,
		"WORKSPACE": 2,
	}
...
func (x CreateTrustedAccountRequest_Scope) Enum() *CreateTrustedAccountRequest_Scope {
	p := new(CreateTrustedAccountRequest_Scope)
	*p = x
	return p
}

func (x CreateTrustedAccountRequest_Scope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CreateTrustedAccountRequest_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[0].Descriptor()
}

func (CreateTrustedAccountRequest_Scope) Type() protoreflect.EnumType {
	return &file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[0]
}

func (x CreateTrustedAccountRequest_Scope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CreateTrustedAccountRequest_Scope.Descriptor instead.
func (CreateTrustedAccountRequest_Scope) EnumDescriptor() ([]byte, []int) {
	return file_spaceone_api_identity_v2_trusted_account_proto_rawDescGZIP(), []int{0, 0}
}

type TrustedAccountSearchQuery_Scope int32

const (
	TrustedAccountSearchQuery_NONE      TrustedAccountSearchQuery_Scope = 0
	TrustedAccountSearchQuery_DOMAIN    TrustedAccountSearchQuery_Scope = 1
	TrustedAccountSearchQuery_WORKSPACE TrustedAccountSearchQuery_Scope = 2
)

// Enum value maps for TrustedAccountSearchQuery_Scope.
var (
	TrustedAccountSearchQuery_Scope_name = map[int32]string{
		0: "NONE",
		1: "DOMAIN",
		2: "WORKSPACE",
	}
	TrustedAccountSearchQuery_Scope_value = map[string]int32{
		"NONE":      0,
		"DOMAIN":    1,
		"WORKSPACE": 2,
	}
...
func (x TrustedAccountSearchQuery_Scope) Enum() *TrustedAccountSearchQuery_Scope {
	p := new(TrustedAccountSearchQuery_Scope)
	*p = x
	return p
}

func (x TrustedAccountSearchQuery_Scope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrustedAccountSearchQuery_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[1].Descriptor()
}

func (TrustedAccountSearchQuery_Scope) Type() protoreflect.EnumType {
	return &file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[1]
}

func (x TrustedAccountSearchQuery_Scope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrustedAccountSearchQuery_Scope.Descriptor instead.
func (TrustedAccountSearchQuery_Scope) EnumDescriptor() ([]byte, []int) {
	return file_spaceone_api_identity_v2_trusted_account_proto_rawDescGZIP(), []int{3, 0}
}

type TrustedAccountInfo_Scope int32

const (
	TrustedAccountInfo_NONE      TrustedAccountInfo_Scope = 0
	TrustedAccountInfo_DOMAIN    TrustedAccountInfo_Scope = 1
	TrustedAccountInfo_WORKSPACE TrustedAccountInfo_Scope = 2
)

// Enum value maps for TrustedAccountInfo_Scope.
var (
	TrustedAccountInfo_Scope_name = map[int32]string{
		0: "NONE",
		1: "DOMAIN",
		2: "WORKSPACE",
	}
	TrustedAccountInfo_Scope_value = map[string]int32{
		"NONE":      0,
		"DOMAIN":    1,
		"WORKSPACE": 2,
	}
...
func (x TrustedAccountInfo_Scope) Enum() *TrustedAccountInfo_Scope {
	p := new(TrustedAccountInfo_Scope)
	*p = x
	return p
}

func (x TrustedAccountInfo_Scope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrustedAccountInfo_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[2].Descriptor()
}

func (TrustedAccountInfo_Scope) Type() protoreflect.EnumType {
	return &file_spaceone_api_identity_v2_trusted_account_proto_enumTypes[2]
}

func (x TrustedAccountInfo_Scope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrustedAccountInfo_Scope.Descriptor instead.
func (TrustedAccountInfo_Scope) EnumDescriptor() ([]byte, []int) {
...
type CreateTrustedAccountRequest struct {
	...
	Scope    CreateTrustedAccountRequest_Scope `protobuf:"varint,5,opt,name=scope,proto3,enum=spaceone.api.identity.v2.CreateTrustedAccountRequest_Scope" json:"scope,omitempty"`
...
func (x *CreateTrustedAccountRequest) GetScope() CreateTrustedAccountRequest_Scope {
	if x != nil {
		return x.Scope
	}
...
type TrustedAccountSearchQuery struct {
	...
	// +optional
	Scope    TrustedAccountSearchQuery_Scope `protobuf:"varint,8,opt,name=scope,proto3,enum=spaceone.api.identity.v2.TrustedAccountSearchQuery_Scope" json:"scope,omitempty"`
	DomainId string                          `protobuf:"bytes,21,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
	// +optional
	WorkspaceId string `protobuf:"bytes,22,opt,name=workspace_id,json=workspaceId,proto3" json:"workspace_id,omitempty"`
}
...
func (x *TrustedAccountSearchQuery) GetScope() TrustedAccountSearchQuery_Scope {
	if x != nil {
		return x.Scope
	}
...
type TrustedAccountInfo struct {
	...
	Scope            TrustedAccountInfo_Scope `protobuf:"varint,6,opt,name=scope,proto3,enum=spaceone.api.identity.v2.TrustedAccountInfo_Scope" json:"scope,omitempty"`
	DomainId         string                   `protobuf:"bytes,21,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
	WorkspaceId      string                   `protobuf:"bytes,22,opt,name=workspace_id,json=workspaceId,proto3" json:"workspace_id,omitempty"`
...
func (x *TrustedAccountInfo) GetScope() TrustedAccountInfo_Scope {
	if x != nil {
		return x.Scope
	}
...
var file_spaceone_api_identity_v2_trusted_account_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe8, 0x02, 0x0a, 0x1b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x51, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3b,
	...
	0x49, 0x64, 0x22, 0x2c, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4e,
	...
	0x22, 0xf9, 0x01, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x72, 0x75, 0x73, 0x74,
	...
	0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x22, 0x85, 0x01, 0x0a,
	0x15, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x12, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65,
	...
	0x63, 0x65, 0x49, 0x64, 0x22, 0xeb, 0x02, 0x0a, 0x19, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64,
	...
	0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x2c, 0x0a, 0x12, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64,
	...
	0x64, 0x65, 0x72, 0x12, 0x4f, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01,
	...
	0x75, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x51, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x52, 0x05, 0x73,
	...
	0x10, 0x02, 0x22, 0xa3, 0x03, 0x0a, 0x12, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63,
	...
	0x73, 0x12, 0x48, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e,
	...
	0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x53,
	...
	0x4b, 0x53, 0x50, 0x41, 0x43, 0x45, 0x10, 0x02, 0x22, 0x7e, 0x0a, 0x13, 0x54, 0x72, 0x75, 0x73,
	0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x72, 0x75, 0x73,
	0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x07,
	...
	0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x96, 0x01, 0x0a, 0x17, 0x54, 0x72, 0x75,
	0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x51,
	...
	0x64, 0x32, 0x86, 0x07, 0x0a, 0x0e, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x9d, 0x01, 0x0a, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12,
	...
	0x65, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52,
	...
	0x75, 0x73, 0x74, 0x65, 0x64, 0x2d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x63, 0x72,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x28, 0x3a, 0x01, 0x2a, 0x22,
	0x23, 0x2f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2f, 0x76, 0x32, 0x2f, 0x74, 0x72,
	0x75, 0x73, 0x74, 0x65, 0x64, 0x2d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x75, 0x70,
	...
	0x74, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x91, 0x01, 0x0a, 0x03, 0x67, 0x65, 0x74,
	...
	0x2d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x67, 0x65, 0x74, 0x12, 0x98, 0x01, 0x0a,
	...
	0x6e, 0x74, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x80, 0x01, 0x0a, 0x04, 0x73, 0x74, 0x61, 0x74,
	0x12, 0x31, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x72, 0x75, 0x73,
	0x74, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x51, 0x75,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69,
...
var file_spaceone_api_identity_v2_trusted_account_proto_goTypes = []interface{}{
	(CreateTrustedAccountRequest_Scope)(0), // 0: spaceone.api.identity.v2.CreateTrustedAccountRequest.Scope
	(TrustedAccountSearchQuery_Scope)(0),   // 1: spaceone.api.identity.v2.TrustedAccountSearchQuery.Scope
	(TrustedAccountInfo_Scope)(0),          // 2: spaceone.api.identity.v2.TrustedAccountInfo.Scope
...
var file_spaceone_api_identity_v2_trusted_account_proto_depIdxs = []int32{
	...
	0,  // 2: spaceone.api.identity.v2.CreateTrustedAccountRequest.scope:type_name -> spaceone.api.identity.v2.CreateTrustedAccountRequest.Scope
	...
	1,  // 6: spaceone.api.identity.v2.TrustedAccountSearchQuery.scope:type_name -> spaceone.api.identity.v2.TrustedAccountSearchQuery.Scope
	...
	2,  // 9: spaceone.api.identity.v2.TrustedAccountInfo.scope:type_name -> spaceone.api.identity.v2.TrustedAccountInfo.Scope
