...
type VerifyAPIKeyRequest_API_KEY_TYPE int32

const (
	VerifyAPIKeyRequest_NONE VerifyAPIKeyRequest_API_KEY_TYPE = 0
	VerifyAPIKeyRequest_APP  VerifyAPIKeyRequest_API_KEY_TYPE = 1
	VerifyAPIKeyRequest_USER VerifyAPIKeyRequest_API_KEY_TYPE = 2
)

// Enum value maps for VerifyAPIKeyRequest_API_KEY_TYPE.
var (
	VerifyAPIKeyRequest_API_KEY_TYPE_name = map[int32]string{
		0: "NONE",
		1: "APP",
		2: "USER",
	}
	VerifyAPIKeyRequest_API_KEY_TYPE_value = map[string]int32{
		"NONE": 0,
		"APP":  1,
		"USER": 2,
	}
...
func (x VerifyAPIKeyRequest_API_KEY_TYPE) Enum() *VerifyAPIKeyRequest_API_KEY_TYPE {
	p := new(VerifyAPIKeyRequest_API_KEY_TYPE)
	*p = x
	return p
}

func (x VerifyAPIKeyRequest_API_KEY_TYPE) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VerifyAPIKeyRequest_API_KEY_TYPE) Descriptor() protoreflect.EnumDescriptor {
	return file_spaceone_api_identity_v2_api_key_proto_enumTypes[0].Descriptor()
}

func (VerifyAPIKeyRequest_API_KEY_TYPE) Type() protoreflect.EnumType {
	return &file_spaceone_api_identity_v2_api_key_proto_enumTypes[0]
}

func (x VerifyAPIKeyRequest_API_KEY_TYPE) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VerifyAPIKeyRequest_API_KEY_TYPE.Descriptor instead.
func (VerifyAPIKeyRequest_API_KEY_TYPE) EnumDescriptor() ([]byte, []int) {
	return file_spaceone_api_identity_v2_api_key_proto_rawDescGZIP(), []int{2, 0}
}
...
func (APIKeySearchQuery_State) Descriptor() protoreflect.EnumDescriptor {
	return file_spaceone_api_identity_v2_api_key_proto_enumTypes[2].Descriptor()
}

func (APIKeySearchQuery_State) Type() protoreflect.EnumType {
	return &file_spaceone_api_identity_v2_api_key_proto_enumTypes[2]
}
...
func (APIKeySearchQuery_State) EnumDescriptor() ([]byte, []int) {
	return file_spaceone_api_identity_v2_api_key_proto_rawDescGZIP(), []int{5, 0}
}
...
type VerifyAPIKeyRequest struct {
	...
	ApiKeyId   string                           `protobuf:"bytes,1,opt,name=api_key_id,json=apiKeyId,proto3" json:"api_key_id,omitempty"`
	ApiKeyType VerifyAPIKeyRequest_API_KEY_TYPE `protobuf:"varint,2,opt,name=api_key_type,json=apiKeyType,proto3,enum=spaceone.api.identity.v2.VerifyAPIKeyRequest_API_KEY_TYPE" json:"api_key_type,omitempty"`
	DomainId   string                           `protobuf:"bytes,21,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
	// Types that are assignable to ApiKeyInfo:
	//
	//	*VerifyAPIKeyRequest_AppId
	//	*VerifyAPIKeyRequest_UserId
	ApiKeyInfo isVerifyAPIKeyRequest_ApiKeyInfo `protobuf_oneof:"api_key_info"`
}
...
func (x *VerifyAPIKeyRequest) GetApiKeyId() string {
	if x != nil {
		return x.ApiKeyId
	}
	return ""
...
func (x *VerifyAPIKeyRequest) GetApiKeyType() VerifyAPIKeyRequest_API_KEY_TYPE {
	if x != nil {
		return x.ApiKeyType
	}
	return VerifyAPIKeyRequest_NONE
}

func (x *VerifyAPIKeyRequest) GetDomainId() string {
	if x != nil {
		return x.DomainId
	}
	return ""
...
func (m *VerifyAPIKeyRequest) GetApiKeyInfo() isVerifyAPIKeyRequest_ApiKeyInfo {
	if m != nil {
		return m.ApiKeyInfo
	}
	return nil
...
func (x *VerifyAPIKeyRequest) GetAppId() string {
	if x, ok := x.GetApiKeyInfo().(*VerifyAPIKeyRequest_AppId); ok {
		return x.AppId
	}
	return ""
}

func (x *VerifyAPIKeyRequest) GetUserId() string {
	if x, ok := x.GetApiKeyInfo().(*VerifyAPIKeyRequest_UserId); ok {
		return x.UserId
	}
	return ""
}

type isVerifyAPIKeyRequest_ApiKeyInfo interface {
	isVerifyAPIKeyRequest_ApiKeyInfo()
}

type VerifyAPIKeyRequest_AppId struct {
	AppId string `protobuf:"bytes,22,opt,name=app_id,json=appId,proto3,oneof"`
}

type VerifyAPIKeyRequest_UserId struct {
	UserId string `protobuf:"bytes,23,opt,name=user_id,json=userId,proto3,oneof"`
}

func (*VerifyAPIKeyRequest_AppId) isVerifyAPIKeyRequest_ApiKeyInfo() {}

func (*VerifyAPIKeyRequest_UserId) isVerifyAPIKeyRequest_ApiKeyInfo() {}
...
func (x *APIKeyStatQuery) Reset() {
	*x = APIKeyStatQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_spaceone_api_identity_v2_api_key_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*APIKeyStatQuery) Descriptor() ([]byte, []int) {
	return file_spaceone_api_identity_v2_api_key_proto_rawDescGZIP(), []int{7}
}
...
var file_spaceone_api_identity_v2_api_key_proto_rawDesc = []byte{
	...
	0x6e, 0x49, 0x64, 0x22, 0x9f, 0x02, 0x0a, 0x13, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x41, 0x50,
	...
	0x08, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x5c, 0x0a, 0x0c, 0x61, 0x70, 0x69,
	0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x73, 0x70, 0x61,
	...
	0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x41, 0x74, 0x22, 0x32, 0x0a, 0x05, 0x53,
	...
	0x97, 0x02, 0x0a, 0x11, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x79, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x1c, 0x0a, 0x0a, 0x61, 0x70, 0x69, 0x5f,
	0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x70,
	0x69, 0x4b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x47, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0e,
	...
	0x49, 0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x22, 0x6e, 0x0a, 0x0b, 0x41, 0x50, 0x49,
	0x4b, 0x65, 0x79, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x3e, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75,
	...
	0x79, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6b, 0x0a, 0x0f, 0x41, 0x50, 0x49,
	0x4b, 0x65, 0x79, 0x53, 0x74, 0x61, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x3b, 0x0a, 0x05,
	...
	0x6d, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x32, 0xe1, 0x08, 0x0a, 0x06, 0x41, 0x50, 0x49, 0x4b, 0x65,
	0x79, 0x12, 0x85, 0x01, 0x0a, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x2d, 0x2e, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x50,
	...
	0x65, 0x79, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x85, 0x01, 0x0a, 0x06, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x12, 0x2d, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e,
	...
	0x76, 0x32, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x6b, 0x65, 0x79, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x12, 0x7f, 0x0a, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x27, 0x2e, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71,
	...
	0x2f, 0x76, 0x32, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x6b, 0x65, 0x79, 0x2f, 0x65, 0x6e, 0x61, 0x62,
	0x6c, 0x65, 0x12, 0x81, 0x01, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x27,
	...
	0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e,
	0x76, 0x32, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x27, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x21, 0x3a, 0x01, 0x2a, 0x22, 0x1c, 0x2f, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x6b, 0x65, 0x79, 0x2f, 0x64,
	0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x71, 0x0a, 0x06, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x79, 0x22, 0x26, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x20, 0x3a, 0x01, 0x2a, 0x22, 0x1b, 0x2f, 0x69,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x6b,
	0x65, 0x79, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x5f, 0x0a, 0x06, 0x76, 0x65, 0x72,
	0x69, 0x66, 0x79, 0x12, 0x2d, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x56,
	0x65, 0x72, 0x69, 0x66, 0x79, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x49, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x00, 0x12, 0x79, 0x0a, 0x03, 0x67, 0x65,
	...
	0x79, 0x2f, 0x67, 0x65, 0x74, 0x12, 0x80, 0x01, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x2b,
	0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79,
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x51, 0x75, 0x65, 0x72, 0x79, 0x1a, 0x25, 0x2e, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x6f, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x73, 0x49, 0x6e,
	...
	,
...
var file_spaceone_api_identity_v2_api_key_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_spaceone_api_identity_v2_api_key_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_spaceone_api_identity_v2_api_key_proto_goTypes = []interface{}{
	(VerifyAPIKeyRequest_API_KEY_TYPE)(0), // 0: spaceone.api.identity.v2.VerifyAPIKeyRequest.API_KEY_TYPE
	(APIKeyInfo_State)(0),                 // 1: spaceone.api.identity.v2.APIKeyInfo.State
	(APIKeySearchQuery_State)(0),          // 2: spaceone.api.identity.v2.APIKeySearchQuery.State
	(*CreateAPIKeyRequest)(nil),           // 3: spaceone.api.identity.v2.CreateAPIKeyRequest
	(*UpdateAPIKeyRequest)(nil),           // 4: spaceone.api.identity.v2.UpdateAPIKeyRequest
	(*VerifyAPIKeyRequest)(nil),           // 5: spaceone.api.identity.v2.VerifyAPIKeyRequest
	(*APIKeyRequest)(nil),                 // 6: spaceone.api.identity.v2.APIKeyRequest
	(*APIKeyInfo)(nil),                    // 7: spaceone.api.identity.v2.APIKeyInfo
	(*APIKeySearchQuery)(nil),             // 8: spaceone.api.identity.v2.APIKeySearchQuery
	(*APIKeysInfo)(nil),                   // 9: spaceone.api.identity.v2.APIKeysInfo
	(*APIKeyStatQuery)(nil),               // 10: spaceone.api.identity.v2.APIKeyStatQuery
...
var file_spaceone_api_identity_v2_api_key_proto_depIdxs = []int32{
	0,  // 0: spaceone.api.identity.v2.VerifyAPIKeyRequest.api_key_type:type_name -> spaceone.api.identity.v2.VerifyAPIKeyRequest.API_KEY_TYPE
	1,  // 1: spaceone.api.identity.v2.APIKeyInfo.state:type_name -> spaceone.api.identity.v2.APIKeyInfo.State
	11, // 2: spaceone.api.identity.v2.APIKeySearchQuery.query:type_name -> spaceone.api.core.v1.Query
	2,  // 3: spaceone.api.identity.v2.APIKeySearchQuery.state:type_name -> spaceone.api.identity.v2.APIKeySearchQuery.State
	7,  // 4: spaceone.api.identity.v2.APIKeysInfo.results:type_name -> spaceone.api.identity.v2.APIKeyInfo
	12, // 5: spaceone.api.identity.v2.APIKeyStatQuery.query:type_name -> spaceone.api.core.v1.StatisticsQuery
	3,  // 6: spaceone.api.identity.v2.APIKey.create:input_type -> spaceone.api.identity.v2.CreateAPIKeyRequest
	4,  // 7: spaceone.api.identity.v2.APIKey.update:input_type -> spaceone.api.identity.v2.UpdateAPIKeyRequest
	6,  // 8: spaceone.api.identity.v2.APIKey.enable:input_type -> spaceone.api.identity.v2.APIKeyRequest
	6,  // 9: spaceone.api.identity.v2.APIKey.disable:input_type -> spaceone.api.identity.v2.APIKeyRequest
	6,  // 10: spaceone.api.identity.v2.APIKey.delete:input_type -> spaceone.api.identity.v2.APIKeyRequest
	5,  // 11: spaceone.api.identity.v2.APIKey.verify:input_type -> spaceone.api.identity.v2.VerifyAPIKeyRequest
	6,  // 12: spaceone.api.identity.v2.APIKey.get:input_type -> spaceone.api.identity.v2.APIKeyRequest
	8,  // 13: spaceone.api.identity.v2.APIKey.list:input_type -> spaceone.api.identity.v2.APIKeySearchQuery
	10, // 14: spaceone.api.identity.v2.APIKey.stat:input_type -> spaceone.api.identity.v2.APIKeyStatQuery
	7,  // 15: spaceone.api.identity.v2.APIKey.create:output_type -> spaceone.api.identity.v2.APIKeyInfo
	7,  // 16: spaceone.api.identity.v2.APIKey.update:output_type -> spaceone.api.identity.v2.APIKeyInfo
	7,  // 17: spaceone.api.identity.v2.APIKey.enable:output_type -> spaceone.api.identity.v2.APIKeyInfo
	7,  // 18: spaceone.api.identity.v2.APIKey.disable:output_type -> spaceone.api.identity.v2.APIKeyInfo
	13, // 19: spaceone.api.identity.v2.APIKey.delete:output_type -> google.protobuf.Empty
	7,  // 20: spaceone.api.identity.v2.APIKey.verify:output_type -> spaceone.api.identity.v2.APIKeyInfo
	7,  // 21: spaceone.api.identity.v2.APIKey.get:output_type -> spaceone.api.identity.v2.APIKeyInfo
	9,  // 22: spaceone.api.identity.v2.APIKey.list:output_type -> spaceone.api.identity.v2.APIKeysInfo
	14, // 23: spaceone.api.identity.v2.APIKey.stat:output_type -> google.protobuf.Struct
...
func file_spaceone_api_identity_v2_api_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_spaceone_api_identity_v2_api_key_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_spaceone_api_identity_v2_api_key_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*VerifyAPIKeyRequest_AppId)(nil),
		(*VerifyAPIKeyRequest_UserId)(nil),
	}
	type x struct{}
