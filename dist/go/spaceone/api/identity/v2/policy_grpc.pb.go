...
const (
	Policy_Create_FullMethodName = "/spaceone.api.identity.v2.Policy/create"
	Policy_Update_FullMethodName = "/spaceone.api.identity.v2.Policy/update"
	Policy_Delete_FullMethodName = "/spaceone.api.identity.v2.Policy/delete"
	Policy_Get_FullMethodName    = "/spaceone.api.identity.v2.Policy/get"
	Policy_List_FullMethodName   = "/spaceone.api.identity.v2.Policy/list"
	Policy_Stat_FullMethodName   = "/spaceone.api.identity.v2.Policy/stat"
)
...
type PolicyClient interface {
	...
	Get(ctx context.Context, in *PolicyRequest, opts ...grpc.CallOption) (*PolicyInfo, error)
	List(ctx context.Context, in *PolicySearchQuery, opts ...grpc.CallOption) (*PoliciesInfo, error)
...
func (c *policyClient) Get(ctx context.Context, in *PolicyRequest, opts ...grpc.CallOption) (*PolicyInfo, error) {
	out := new(PolicyInfo)
...
func (c *policyClient) List(ctx context.Context, in *PolicySearchQuery, opts ...grpc.CallOption) (*PoliciesInfo, error) {
...
type PolicyServer interface {
	...
	Get(context.Context, *PolicyRequest) (*PolicyInfo, error)
	List(context.Context, *PolicySearchQuery) (*PoliciesInfo, error)
...
func (UnimplementedPolicyServer) Get(context.Context, *PolicyRequest) (*PolicyInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedPolicyServer) List(context.Context, *PolicySearchQuery) (*PoliciesInfo, error) {
...
func _Policy_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServer).Get(ctx, req.(*PolicyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Policy_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServer).List(ctx, req.(*PolicySearchQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Policy_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.identity.v2.Policy",
	...
	Metadata: "spaceone/api/identity/v2/policy.proto",
}
