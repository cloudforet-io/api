...
const (
	Authorization_Verify_FullMethodName = "/spaceone.api.identity.v2.Authorization/verify"
)
...
type AuthorizationClient interface {
	Verify(ctx context.Context, in *v2.AuthorizationRequest, opts ...grpc.CallOption) (*v2.AuthorizationResponse, error)
}
...
func (c *authorizationClient) Verify(ctx context.Context, in *v2.AuthorizationRequest, opts ...grpc.CallOption) (*v2.AuthorizationResponse, error) {
	out := new(v2.AuthorizationResponse)
	err := c.cc.Invoke(ctx, Authorization_Verify_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorizationServer interface {
	Verify(context.Context, *v2.AuthorizationRequest) (*v2.AuthorizationResponse, error)
...
func (UnimplementedAuthorizationServer) Verify(context.Context, *v2.AuthorizationRequest) (*v2.AuthorizationResponse, error) {
...
func _Authorization_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v2.AuthorizationRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).Verify(ctx, req.(*v2.AuthorizationRequest))
	}
...
var Authorization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.identity.v2.Authorization",
	...
	Metadata: "spaceone/api/identity/v2/authorization.proto",
}
