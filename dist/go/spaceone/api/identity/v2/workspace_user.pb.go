...
const file_spaceone_api_identity_v2_workspace_user_proto_rawDesc = "" +
	...
	"\aPENDING\x10\x03\"R\n" +
	"\x14WorkspaceUserRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\"\x9d\x06\n" +
	"\x11WorkspaceUserInfo\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12G\n" +
	"\x05state\x18\x03 \x01(\x0e21.spaceone.api.identity.v2.WorkspaceUserInfo.StateR\x05state\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12?\n" +
	"\tauth_type\x18\x05 \x01(\x0e2\".spaceone.api.identity.v2.AuthTypeR\bauthType\x12Q\n" +
	"\trole_type\x18\x06 \x01(\x0e24.spaceone.api.identity.v2.WorkspaceUserInfo.RoleTypeR\broleType\x12\x1a\n" +
	"\blanguage\x18\a \x01(\tR\blanguage\x12\x1a\n" +
	"\btimezone\x18\b \x01(\tR\btimezone\x12\"\n" +
	"\rapi_key_count\x18\t \x01(\x05R\vapiKeyCount\x12+\n" +
	"\x04tags\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\x04tags\x12U\n" +
	"\x11role_binding_info\x18\v \x01(\v2).spaceone.api.identity.v2.RoleBindingInfoR\x0froleBindingInfo\x12%\n" +
	"\x0eemail_verified\x18\f \x01(\bR\remailVerified\x12\x1b\n" +
	...
	"\x04USER\x10\x02\"\x9c\x03\n" +
	"\x18WorkspaceUserSearchQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12N\n" +
	"\x05state\x18\x04 \x01(\x0e28.spaceone.api.identity.v2.WorkspaceUserSearchQuery.StateR\x05state\x12\x14\n" +
	"\x05email\x18\x05 \x01(\tR\x05email\x12?\n" +
	"\tauth_type\x18\x06 \x01(\x0e2\".spaceone.api.identity.v2.AuthTypeR\bauthType\x12\x1b\n" +
	"\trole_type\x18\a \x01(\tR\broleType\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\"9\n" +
	"\x05State\x12\b\n" +
	"\x04NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	...
	"\bDISABLED\x10\x02\x12\v\n" +
	"\aPENDING\x10\x03\"x\n" +
	"\x10UsersSummaryInfo\x12C\n" +
	"\aresults\x18\x01 \x03(\v2).spaceone.api.identity.v2.UserSummaryInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"x\n" +
	"\x16WorkspaceUserStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId2\xeb\x05\n" +
	"\rWorkspaceUser\x12\x9a\x01\n" +
	"\x06create\x124.spaceone.api.identity.v2.CreateWorkspaceUserRequest\x1a+.spaceone.api.identity.v2.WorkspaceUserInfo\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/identity/v2/workspace-user/create\x12\x8e\x01\n" +
	"\x03get\x12..spaceone.api.identity.v2.WorkspaceUserRequest\x1a+.spaceone.api.identity.v2.WorkspaceUserInfo\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/identity/v2/workspace-user/get\x12\x93\x01\n" +
	"\x04find\x122.spaceone.api.identity.v2.WorkspaceUserFindRequest\x1a*.spaceone.api.identity.v2.UsersSummaryInfo\"+\x82\xd3\xe4\x93\x02%:\x01*\" /identity/v2/workspace-user/find\x12\x95\x01\n" +
	"\x04list\x122.spaceone.api.identity.v2.WorkspaceUserSearchQuery\x1a,.spaceone.api.identity.v2.WorkspaceUsersInfo\"+\x82\xd3\xe4\x93\x02%:\x01*\" /identity/v2/workspace-user/list\x12~\n" +
	"\x04stat\x120.spaceone.api.identity.v2.WorkspaceUserStatQuery\x1a\x17.google.protobuf.Struct\"+\x82\xd3\xe4\x93\x02%:\x01*\" /identity/v1/workspace-user/statB?Z=github.com/cloudforet-io/api/dist/go/spaceone/api/identity/v2b\x06proto3"
