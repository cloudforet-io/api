...
func (c *roleClient) Create(ctx context.Context, in *CreateRoleRequest, opts ...grpc.CallOption) (*RoleInfo, error) {
	out := new(RoleInfo)
	err := c.cc.Invoke(ctx, Role_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roleClient) List(ctx context.Context, in *RoleQuery, opts ...grpc.CallOption) (*RolesInfo, error) {
	out := new(RolesInfo)
...
func (c *roleClient) Stat(ctx context.Context, in *RoleStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, Role_Stat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRoleServer) List(context.Context, *RoleQuery) (*RolesInfo, error) {
...
func _Role_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServer).List(ctx, req.(*RoleQuery))
	}
	return interceptor(ctx, in, info, handler)
}
