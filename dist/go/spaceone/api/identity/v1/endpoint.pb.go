...
var file_spaceone_api_identity_v1_endpoint_proto_goTypes = []interface{}{
...
func file_spaceone_api_identity_v1_endpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_identity_v1_endpoint_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_spaceone_api_identity_v1_endpoint_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EndpointQuery); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_spaceone_api_identity_v1_endpoint_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
