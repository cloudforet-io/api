...
// UnimplementedPublicFolderServer must be embedded to have
...
func (UnimplementedPublicFolderServer) testEmbeddedByValue()                      {}
...
func RegisterPublicFolderServer(s grpc.ServiceRegistrar, srv PublicFolderServer) {
	// If the following call pancis, it indicates UnimplementedPublicFolderServer was
...
func _PublicFolder_Share_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(PublicFolderServer).Share(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
