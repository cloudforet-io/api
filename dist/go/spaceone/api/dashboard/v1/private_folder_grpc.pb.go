...
// UnimplementedPrivateFolderServer must be embedded to have
...
func (UnimplementedPrivateFolderServer) testEmbeddedByValue()                       {}
...
func RegisterPrivateFolderServer(s grpc.ServiceRegistrar, srv PrivateFolderServer) {
	// If the following call pancis, it indicates UnimplementedPrivateFolderServer was
