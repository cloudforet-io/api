...
const (
	PrivateWidget_Create_FullMethodName = "/spaceone.api.widget.v1.PrivateWidget/create"
	PrivateWidget_Update_FullMethodName = "/spaceone.api.widget.v1.PrivateWidget/update"
	PrivateWidget_Delete_FullMethodName = "/spaceone.api.widget.v1.PrivateWidget/delete"
	PrivateWidget_Load_FullMethodName   = "/spaceone.api.widget.v1.PrivateWidget/load"
	PrivateWidget_Get_FullMethodName    = "/spaceone.api.widget.v1.PrivateWidget/get"
	PrivateWidget_List_FullMethodName   = "/spaceone.api.widget.v1.PrivateWidget/list"
)
...
func (c *privateWidgetClient) Create(ctx context.Context, in *CreatePrivateWidgetRequest, opts ...grpc.CallOption) (*PrivateWidgetInfo, error) {
	...
	err := c.cc.Invoke(ctx, PrivateWidget_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateWidgetClient) Update(ctx context.Context, in *UpdatePrivateWidgetRequest, opts ...grpc.CallOption) (*PrivateWidgetInfo, error) {
	out := new(PrivateWidgetInfo)
	err := c.cc.Invoke(ctx, PrivateWidget_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateWidgetClient) Delete(ctx context.Context, in *PrivateWidgetRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, PrivateWidget_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateWidgetClient) Load(ctx context.Context, in *LoadPrivateWidgetRequest, opts ...grpc.CallOption) (*PrivateWidgetInfo, error) {
	out := new(PrivateWidgetInfo)
	err := c.cc.Invoke(ctx, PrivateWidget_Load_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateWidgetClient) Get(ctx context.Context, in *PrivateWidgetRequest, opts ...grpc.CallOption) (*PrivateWidgetInfo, error) {
	out := new(PrivateWidgetInfo)
	err := c.cc.Invoke(ctx, PrivateWidget_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateWidgetClient) List(ctx context.Context, in *PrivateWidgetQuery, opts ...grpc.CallOption) (*PrivateWidgetsInfo, error) {
	...
	err := c.cc.Invoke(ctx, PrivateWidget_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPrivateWidgetServer must be embedded to have forward compatible implementations.
...
var PrivateWidget_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.widget.v1.PrivateWidget",
