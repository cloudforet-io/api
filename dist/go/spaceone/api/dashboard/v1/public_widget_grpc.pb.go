...
type PublicWidgetClient interface {
	...
	LoadSum(ctx context.Context, in *LoadSumPublicWidgetRequest, opts ...grpc.CallOption) (*_struct.Struct, error)
...
func (c *publicWidgetClient) Create(ctx context.Context, in *CreatePublicWidgetRequest, opts ...grpc.CallOption) (*PublicWidgetInfo, error) {
	...
	err := c.cc.Invoke(ctx, PublicWidget_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicWidgetClient) Update(ctx context.Context, in *UpdatePublicWidgetRequest, opts ...grpc.CallOption) (*PublicWidgetInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublicWidgetInfo)
	err := c.cc.Invoke(ctx, PublicWidget_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicWidgetClient) Delete(ctx context.Context, in *PublicWidgetRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, PublicWidget_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicWidgetClient) LoadSum(ctx context.Context, in *LoadSumPublicWidgetRequest, opts ...grpc.CallOption) (*_struct.Struct, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(_struct.Struct)
...
func (c *publicWidgetClient) Get(ctx context.Context, in *PublicWidgetRequest, opts ...grpc.CallOption) (*PublicWidgetInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublicWidgetInfo)
	err := c.cc.Invoke(ctx, PublicWidget_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicWidgetClient) List(ctx context.Context, in *PublicWidgetQuery, opts ...grpc.CallOption) (*PublicWidgetsInfo, error) {
	...
	err := c.cc.Invoke(ctx, PublicWidget_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PublicWidgetServer interface {
	...
	LoadSum(context.Context, *LoadSumPublicWidgetRequest) (*_struct.Struct, error)
...
// UnimplementedPublicWidgetServer must be embedded to have
...
func (UnimplementedPublicWidgetServer) LoadSum(context.Context, *LoadSumPublicWidgetRequest) (*_struct.Struct, error) {
...
func (UnimplementedPublicWidgetServer) testEmbeddedByValue()                      {}
...
func RegisterPublicWidgetServer(s grpc.ServiceRegistrar, srv PublicWidgetServer) {
	// If the following call pancis, it indicates UnimplementedPublicWidgetServer was
...
func _PublicWidget_LoadSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoadSumPublicWidgetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicWidgetServer).LoadSum(ctx, req.(*LoadSumPublicWidgetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PublicWidget_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.dashboard.v1.PublicWidget",
