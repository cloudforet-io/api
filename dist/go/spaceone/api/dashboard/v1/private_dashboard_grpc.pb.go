...
// UnimplementedPrivateDashboardServer must be embedded to have
...
func (UnimplementedPrivateDashboardServer) testEmbeddedByValue()                          {}
...
func RegisterPrivateDashboardServer(s grpc.ServiceRegistrar, srv PrivateDashboardServer) {
	// If the following call pancis, it indicates UnimplementedPrivateDashboardServer was
