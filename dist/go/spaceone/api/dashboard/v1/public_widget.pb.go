...
const file_spaceone_api_dashboard_v1_public_widget_proto_rawDesc = "" +
	"\n" +
	"-spaceone/api/dashboard/v1/public_widget.proto\x12\x19spaceone.api.dashboard.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"\xfa\x03\n" +
	...
	"\twidget_id\x18\x01 \x01(\tR\bwidgetId\"\xa7\x01\n" +
	"\x17LoadPublicWidgetRequest\x12\x1b\n" +
	"\twidget_id\x18\x01 \x01(\tR\bwidgetId\x12B\n" +
	"\x05query\x18\x02 \x01(\v2,.spaceone.api.core.v2.TimeSeriesAnalyzeQueryR\x05query\x12+\n" +
	"\x04vars\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x04vars\"\x9a\x01\n" +
	...
	"\x04load\x122.spaceone.api.dashboard.v1.LoadPublicWidgetRequest\x1a\x17.google.protobuf.Struct\"+\x82\xd3\xe4\x93\x02%:\x01*\" /dashboard/v1/public-widget/load\x12\x8e\x01\n" +
