...
var file_spaceone_api_config_v1_domain_config_proto_rawDesc = []byte{
	...
	0x6e, 0x2d, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x42, 0x3d, 0x5a,
...
func file_spaceone_api_config_v1_domain_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_config_v1_domain_config_proto_msgTypes[5].Exporter = func(v any, i int) any {
