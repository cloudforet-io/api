...
const file_spaceone_api_config_v1_domain_config_proto_rawDesc = "" +
	...
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xc7\a\n" +
	...
	"\x04list\x12/.spaceone.api.config.v1.DomainConfigSearchQuery\x1a).spaceone.api.config.v1.DomainConfigsInfo\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/config/v1/domain-config/list\x12x\n" +
	"\x04stat\x12-.spaceone.api.config.v1.DomainConfigStatQuery\x1a\x17.google.protobuf.Struct\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/config/v1/domain-config/statB=Z;github.com/cloudforet-io/api/dist/go/spaceone/api/config/v1b\x06proto3"
