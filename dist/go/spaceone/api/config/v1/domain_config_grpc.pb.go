...
// UnimplementedDomainConfigServer must be embedded to have
...
func (UnimplementedDomainConfigServer) testEmbeddedByValue()                      {}
...
func RegisterDomainConfigServer(s grpc.ServiceRegistrar, srv DomainConfigServer) {
	// If the following call pancis, it indicates UnimplementedDomainConfigServer was
