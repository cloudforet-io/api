...
type PublicConfigClient interface {
	Create(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error)
	Update(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error)
	Set(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error)
...
func (c *publicConfigClient) Create(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error) {
...
func (c *publicConfigClient) Update(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublicConfigInfo)
...
func (c *publicConfigClient) Set(ctx context.Context, in *SetPublicConfigRequest, opts ...grpc.CallOption) (*PublicConfigInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublicConfigInfo)
...
type PublicConfigServer interface {
	Create(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error)
	Update(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error)
	Set(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error)
...
func (UnimplementedPublicConfigServer) Create(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedPublicConfigServer) Update(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedPublicConfigServer) Set(context.Context, *SetPublicConfigRequest) (*PublicConfigInfo, error) {
...
func _PublicConfig_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicConfigServer).Create(ctx, req.(*SetPublicConfigRequest))
	}
...
func _PublicConfig_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicConfigServer).Update(ctx, req.(*SetPublicConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PublicConfig_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicConfigServer).Set(ctx, req.(*SetPublicConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
