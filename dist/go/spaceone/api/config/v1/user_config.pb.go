...
const file_spaceone_api_config_v1_user_config_proto_rawDesc = "" +
	...
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xa2\x06\n" +
	"\n" +
	...
	"\x04list\x12'.spaceone.api.config.v1.UserConfigQuery\x1a'.spaceone.api.config.v1.UserConfigsInfo\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/config/v1/user-config/listB=Z;github.com/cloudforet-io/api/dist/go/spaceone/api/config/v1b\x06proto3"
...
var file_spaceone_api_config_v1_user_config_proto_depIdxs = []int32{
	...
	3,  // 13: spaceone.api.config.v1.UserConfig.create:output_type -> spaceone.api.config.v1.UserConfigInfo
	3,  // 14: spaceone.api.config.v1.UserConfig.update:output_type -> spaceone.api.config.v1.UserConfigInfo
	3,  // 15: spaceone.api.config.v1.UserConfig.set:output_type -> spaceone.api.config.v1.UserConfigInfo
	9,  // 16: spaceone.api.config.v1.UserConfig.delete:output_type -> google.protobuf.Empty
	3,  // 17: spaceone.api.config.v1.UserConfig.get:output_type -> spaceone.api.config.v1.UserConfigInfo
	4,  // 18: spaceone.api.config.v1.UserConfig.list:output_type -> spaceone.api.config.v1.UserConfigsInfo
