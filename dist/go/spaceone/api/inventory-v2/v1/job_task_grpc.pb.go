...
func (c *jobTaskClient) Delete(ctx context.Context, in *JobTaskRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	...
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, JobTask_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobTaskClient) List(ctx context.Context, in *JobTaskQuery, opts ...grpc.CallOption) (*JobTasksInfo, error) {
	...
	err := c.cc.Invoke(ctx, JobTask_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobTaskClient) Stat(ctx context.Context, in *JobTaskStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, JobTask_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedJobTaskServer must be embedded to have
...
func (UnimplementedJobTaskServer) testEmbeddedByValue()                 {}
...
func RegisterJobTaskServer(s grpc.ServiceRegistrar, srv JobTaskServer) {
	// If the following call pancis, it indicates UnimplementedJobTaskServer was
...
var JobTask_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.inventory_v2.v1.JobTask",
	...
	Metadata: "spaceone/api/inventory_v2/v1/job_task.proto",
}
