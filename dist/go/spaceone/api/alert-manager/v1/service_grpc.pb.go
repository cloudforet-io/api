...
func (c *serviceClient) Create(ctx context.Context, in *ServiceCreateRequest, opts ...grpc.CallOption) (*ServiceInfo, error) {
...
func (c *serviceClient) Update(ctx context.Context, in *ServiceUpdateRequest, opts ...grpc.CallOption) (*ServiceInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceInfo)
...
func (c *serviceClient) List(ctx context.Context, in *ServiceSearchQuery, opts ...grpc.CallOption) (*ServicesInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *serviceClient) Stat(ctx context.Context, in *ServiceStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedServiceServer) Create(context.Context, *ServiceCreateRequest) (*ServiceInfo, error) {
...
func (UnimplementedServiceServer) Stat(context.Context, *ServiceStatQuery) (*_struct.Struct, error) {
...
func _Service_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).List(ctx, req.(*ServiceSearchQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Service_Stat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Stat(ctx, req.(*ServiceStatQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "spaceone/api/alert_manager/v1/service.proto",
}
