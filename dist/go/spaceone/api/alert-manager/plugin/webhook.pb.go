...
const file_spaceone_api_alert_manager_plugin_webhook_proto_rawDesc = "" +
	"\n" +
	"/spaceone/api/alert_manager/plugin/webhook.proto\x12!spaceone.api.alert_manager.plugin\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\"]\n" +
	"\vInitRequest\x121\n" +
	"\aoptions\x18\x01 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\"_\n" +
	"\rVerifyRequest\x121\n" +
	"\aoptions\x18\x01 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12\x1b\n" +
...
var (
	...
	file_spaceone_api_alert_manager_plugin_webhook_proto_rawDescData []byte
)
...
func file_spaceone_api_alert_manager_plugin_webhook_proto_rawDescGZIP() []byte {
	file_spaceone_api_alert_manager_plugin_webhook_proto_rawDescOnce.Do(func() {
		file_spaceone_api_alert_manager_plugin_webhook_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_alert_manager_plugin_webhook_proto_rawDesc), len(file_spaceone_api_alert_manager_plugin_webhook_proto_rawDesc)))
	})
...
func file_spaceone_api_alert_manager_plugin_webhook_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_alert_manager_plugin_webhook_proto_rawDesc), len(file_spaceone_api_alert_manager_plugin_webhook_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
