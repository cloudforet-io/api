...
const (
	MetricExample_Create_FullMethodName = "/spaceone.api.inventory_v2.v1.MetricExample/create"
	MetricExample_Update_FullMethodName = "/spaceone.api.inventory_v2.v1.MetricExample/update"
	MetricExample_Delete_FullMethodName = "/spaceone.api.inventory_v2.v1.MetricExample/delete"
	MetricExample_Get_FullMethodName    = "/spaceone.api.inventory_v2.v1.MetricExample/get"
	MetricExample_List_FullMethodName   = "/spaceone.api.inventory_v2.v1.MetricExample/list"
	MetricExample_Stat_FullMethodName   = "/spaceone.api.inventory_v2.v1.MetricExample/stat"
)
...
func (c *metricExampleClient) Create(ctx context.Context, in *CreateMetricExampleRequest, opts ...grpc.CallOption) (*MetricExampleInfo, error) {
	...
	err := c.cc.Invoke(ctx, MetricExample_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metricExampleClient) Update(ctx context.Context, in *UpdateMetricExampleRequest, opts ...grpc.CallOption) (*MetricExampleInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MetricExampleInfo)
	err := c.cc.Invoke(ctx, MetricExample_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metricExampleClient) Delete(ctx context.Context, in *MetricExampleRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, MetricExample_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metricExampleClient) Get(ctx context.Context, in *MetricExampleRequest, opts ...grpc.CallOption) (*MetricExampleInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MetricExampleInfo)
	err := c.cc.Invoke(ctx, MetricExample_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metricExampleClient) List(ctx context.Context, in *MetricExampleQuery, opts ...grpc.CallOption) (*MetricExamplesInfo, error) {
	...
	err := c.cc.Invoke(ctx, MetricExample_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metricExampleClient) Stat(ctx context.Context, in *MetricExampleStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, MetricExample_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMetricExampleServer must be embedded to have
...
func (UnimplementedMetricExampleServer) testEmbeddedByValue()                       {}
...
func RegisterMetricExampleServer(s grpc.ServiceRegistrar, srv MetricExampleServer) {
	// If the following call pancis, it indicates UnimplementedMetricExampleServer was
...
var MetricExample_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.inventory_v2.v1.MetricExample",
	...
	Metadata: "spaceone/api/inventory_v2/v1/metric_example.proto",
}
