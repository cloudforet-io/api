...
// UnimplementedMetricDataServer must be embedded to have
...
func (UnimplementedMetricDataServer) testEmbeddedByValue()                    {}
...
func RegisterMetricDataServer(s grpc.ServiceRegistrar, srv MetricDataServer) {
	// If the following call pancis, it indicates UnimplementedMetricDataServer was
...
var MetricData_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "spaceone/api/inventory_v2/v1/metric_data.proto",
}
