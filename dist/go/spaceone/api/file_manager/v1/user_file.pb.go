...
var file_spaceone_api_file_manager_v1_user_file_proto_rawDesc = []byte{
...
var (
	...
	file_spaceone_api_file_manager_v1_user_file_proto_rawDescData = file_spaceone_api_file_manager_v1_user_file_proto_rawDesc
)
...
func file_spaceone_api_file_manager_v1_user_file_proto_rawDescGZIP() []byte {
	file_spaceone_api_file_manager_v1_user_file_proto_rawDescOnce.Do(func() {
		file_spaceone_api_file_manager_v1_user_file_proto_rawDescData = protoimpl.X.CompressGZIP(file_spaceone_api_file_manager_v1_user_file_proto_rawDescData)
	})
...
func file_spaceone_api_file_manager_v1_user_file_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_spaceone_api_file_manager_v1_user_file_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_spaceone_api_file_manager_v1_user_file_proto_rawDesc = nil
