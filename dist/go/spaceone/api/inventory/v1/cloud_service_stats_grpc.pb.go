...
// UnimplementedCloudServiceStatsServer must be embedded to have
...
func (UnimplementedCloudServiceStatsServer) testEmbeddedByValue()                           {}
...
func RegisterCloudServiceStatsServer(s grpc.ServiceRegistrar, srv CloudServiceStatsServer) {
	// If the following call pancis, it indicates UnimplementedCloudServiceStatsServer was
