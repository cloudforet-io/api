...
// UnimplementedChangeHistoryServer must be embedded to have
...
func (UnimplementedChangeHistoryServer) testEmbeddedByValue()                       {}
...
func RegisterChangeHistoryServer(s grpc.ServiceRegistrar, srv ChangeHistoryServer) {
	// If the following call pancis, it indicates UnimplementedChangeHistoryServer was
