...
const file_spaceone_api_inventory_v1_metric_data_proto_rawDesc = "" +
	"\n" +
	"+spaceone/api/inventory/v1/metric_data.proto\x12\x19spaceone.api.inventory.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\x1a&spaceone/api/inventory/v1/metric.proto\"\xa3\x01\n" +
	...
	"\tmetric_id\x18\x02 \x01(\tR\bmetricId2\x9a\x03\n" +
	"\n" +
	"MetricData\x12\x89\x01\n" +
	"\x04list\x12*.spaceone.api.inventory.v1.MetricDataQuery\x1a*.spaceone.api.inventory.v1.MetricDatasInfo\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/inventory/v1/metric-data/list\x12z\n" +
	"\x04stat\x12..spaceone.api.inventory.v1.MetricDataStatQuery\x1a\x17.google.protobuf.Struct\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/inventory/v1/metric-data/stat\x12\x83\x01\n" +
	"\aanalyze\x121.spaceone.api.inventory.v1.MetricDataAnalyzeQuery\x1a\x17.google.protobuf.Struct\",\x82\xd3\xe4\x93\x02&:\x01*\"!/inventory/v1/metric-data/analyzeB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
