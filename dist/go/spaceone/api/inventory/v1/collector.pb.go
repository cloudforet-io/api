...
const file_spaceone_api_inventory_v1_collector_proto_rawDesc = "" +
	"\n" +
	")spaceone/api/inventory/v1/collector.proto\x12\x19spaceone.api.inventory.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\x1a#spaceone/api/inventory/v1/job.proto\"\xa3\x01\n" +
	"\tScheduled\x12I\n" +
	"\x05state\x18\x01 \x01(\x0e23.spaceone.api.inventory.v1.Scheduled.ScheduledStateR\x05state\x12\x14\n" +
	"\x05hours\x18\x02 \x03(\x05R\x05hours\"5\n" +
	"\x0eScheduledState\x12\b\n" +
	"\x04NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\"\x84\x03\n" +
	"\fSecretFilter\x12O\n" +
	"\x05state\x18\x01 \x01(\x0e29.spaceone.api.inventory.v1.SecretFilter.SecretFilterStateR\x05state\x12\x18\n" +
	...
	"\bmetadata\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\bmetadata\x12T\n" +
	"\fupgrade_mode\x18\v \x01(\x0e21.spaceone.api.inventory.v1.PluginInfo.UpgradeModeR\vupgradeMode\"-\n" +
	"\vUpgradeMode\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06MANUAL\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\"\x9d\x04\n" +
	"\x16CreateCollectorRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12F\n" +
	"\vplugin_info\x18\x02 \x01(\v2%.spaceone.api.inventory.v1.PluginInfoR\n" +
	"pluginInfo\x12@\n" +
	"\bschedule\x18\x03 \x01(\v2$.spaceone.api.inventory.v1.ScheduledR\bschedule\x12\x1a\n" +
	"\bprovider\x18\x04 \x01(\tR\bprovider\x12L\n" +
	"\rsecret_filter\x18\x05 \x01(\v2'.spaceone.api.inventory.v1.SecretFilterR\fsecretFilter\x12+\n" +
	"\x04tags\x18\x06 \x01(\v2\x17.google.protobuf.StructR\x04tags\x12f\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e2?.spaceone.api.inventory.v1.CreateCollectorRequest.ResourceGroupR\rresourceGroup\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\"C\n" +
	"\rResourceGroup\x12\x17\n" +
	"\x13RESOURCE_GROUP_NONE\x10\x00\x12\n" +
	"\n" +
	"\x06DOMAIN\x10\x01\x12\r\n" +
	"\tWORKSPACE\x10\x02\"\x8c\x02\n" +
	"\x16UpdateCollectorRequest\x12!\n" +
	"\fcollector_id\x18\x01 \x01(\tR\vcollectorId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12@\n" +
	"\bschedule\x18\x05 \x01(\v2$.spaceone.api.inventory.v1.ScheduledR\bschedule\x12L\n" +
	"\rsecret_filter\x18\x06 \x01(\v2'.spaceone.api.inventory.v1.SecretFilterR\fsecretFilter\x12+\n" +
	"\x04tags\x18\a \x01(\v2\x17.google.protobuf.StructR\x04tags\"\x93\x02\n" +
	...
	"\fupgrade_mode\x18\x05 \x01(\x0e2:.spaceone.api.inventory.v1.UpdatePluginRequest.UpgradeModeR\vupgradeMode\"-\n" +
	"\vUpgradeMode\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06MANUAL\x10\x01\x12\b\n" +
	...
	"\fcollector_id\x18\x01 \x01(\tR\vcollectorId\"\xa7\x03\n" +
	...
	"\x13secret_filter_state\x18\x04 \x01(\x0e2/.spaceone.api.inventory.v1.CollectorQuery.StateR\x11secretFilterState\x12V\n" +
	"\x0eschedule_state\x18\x05 \x01(\x0e2/.spaceone.api.inventory.v1.CollectorQuery.StateR\rscheduleState\x12!\n" +
	...
	"\fcollector_id\x18\x01 \x01(\tR\vcollectorId\x12\x1b\n" +
	"\tsecret_id\x18\x02 \x01(\tR\bsecretId\"\xfd\x05\n" +
	"\rCollectorInfo\x12!\n" +
	"\fcollector_id\x18\x01 \x01(\tR\vcollectorId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bprovider\x18\x03 \x01(\tR\bprovider\x127\n" +
	"\n" +
	"capability\x18\x04 \x01(\v2\x17.google.protobuf.StructR\n" +
	"capability\x12L\n" +
	"\rsecret_filter\x18\x05 \x01(\v2'.spaceone.api.inventory.v1.SecretFilterR\fsecretFilter\x12F\n" +
	"\vplugin_info\x18\x06 \x01(\v2%.spaceone.api.inventory.v1.PluginInfoR\n" +
	"pluginInfo\x12@\n" +
	"\bschedule\x18\a \x01(\v2$.spaceone.api.inventory.v1.ScheduledR\bschedule\x12+\n" +
	"\x04tags\x18\b \x01(\v2\x17.google.protobuf.StructR\x04tags\x12]\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e26.spaceone.api.inventory.v1.CollectorInfo.ResourceGroupR\rresourceGroup\x12\x1b\n" +
	...
	"\x06DOMAIN\x10\x01\x12\r\n" +
	"\tWORKSPACE\x10\x02\"u\n" +
	"\x0eCollectorsInfo\x12B\n" +
	"\aresults\x18\x01 \x03(\v2(.spaceone.api.inventory.v1.CollectorInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"Q\n" +
	"\x12CollectorStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xe4\t\n" +
	"\tCollector\x12\x90\x01\n" +
	"\x06create\x121.spaceone.api.inventory.v1.CreateCollectorRequest\x1a(.spaceone.api.inventory.v1.CollectorInfo\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/inventory/v1/collector/create\x12\x90\x01\n" +
	"\x06update\x121.spaceone.api.inventory.v1.UpdateCollectorRequest\x1a(.spaceone.api.inventory.v1.CollectorInfo\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/inventory/v1/collector/update\x12\x9b\x01\n" +
	"\rupdate_plugin\x12..spaceone.api.inventory.v1.UpdatePluginRequest\x1a(.spaceone.api.inventory.v1.CollectorInfo\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/inventory/v1/collector/update-plugin\x12\x89\x01\n" +
	"\rverify_plugin\x12..spaceone.api.inventory.v1.VerifyPluginRequest\x1a\x16.google.protobuf.Empty\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/inventory/v1/collector/verify-plugin\x12x\n" +
	"\x06delete\x12+.spaceone.api.inventory.v1.CollectorRequest\x1a\x16.google.protobuf.Empty\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/inventory/v1/collector/delete\x12\x84\x01\n" +
	"\x03get\x12+.spaceone.api.inventory.v1.CollectorRequest\x1a(.spaceone.api.inventory.v1.CollectorInfo\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/inventory/v1/collector/get\x12\x85\x01\n" +
	"\x04list\x12).spaceone.api.inventory.v1.CollectorQuery\x1a).spaceone.api.inventory.v1.CollectorsInfo\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/inventory/v1/collector/list\x12w\n" +
	"\x04stat\x12-.spaceone.api.inventory.v1.CollectorStatQuery\x1a\x17.google.protobuf.Struct\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/inventory/v1/collector/stat\x12\x84\x01\n" +
	"\acollect\x12).spaceone.api.inventory.v1.CollectRequest\x1a\".spaceone.api.inventory.v1.JobInfo\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/inventory/v1/collector/collectB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
