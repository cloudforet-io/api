...
const file_spaceone_api_inventory_v1_job_task_proto_rawDesc = "" +
	"\n" +
	...
	"\vjob_task_id\x18\x01 \x01(\tR\tjobTaskId\"\xe0\x03\n" +
	"\fJobTaskQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12\x1e\n" +
	"\vjob_task_id\x18\x02 \x01(\tR\tjobTaskId\x12M\n" +
	"\x06status\x18\x03 \x01(\x0e25.spaceone.api.inventory.v1.JobTaskQuery.JobTaskStatusR\x06status\x12\x1a\n" +
	...
	"\aFAILURE\x10\x05\"\xa8\x06\n" +
	"\vJobTaskInfo\x12\x1e\n" +
	"\vjob_task_id\x18\x01 \x01(\tR\tjobTaskId\x12L\n" +
	"\x06status\x18\x02 \x01(\x0e24.spaceone.api.inventory.v1.JobTaskInfo.JobTaskStatusR\x06status\x12\x1a\n" +
	...
	"\x12disconnected_count\x18\b \x01(\x05R\x11disconnectedCount\x12<\n" +
	"\x06errors\x18\t \x03(\v2$.spaceone.api.inventory.v1.ErrorInfoR\x06errors\x12\x1b\n" +
	...
	"\x06job_id\x18\x19 \x01(\tR\x05jobId\x12\x1b\n" +
	...
	"\aFAILURE\x10\x05\"q\n" +
	"\fJobTasksInfo\x12@\n" +
	"\aresults\x18\x01 \x03(\v2&.spaceone.api.inventory.v1.JobTaskInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"O\n" +
	"\x10JobTaskStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xfa\x03\n" +
	"\aJobTask\x12u\n" +
	"\x06delete\x12).spaceone.api.inventory.v1.JobTaskRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/inventory/v1/job-task/delete\x12\x7f\n" +
	"\x03get\x12).spaceone.api.inventory.v1.JobTaskRequest\x1a&.spaceone.api.inventory.v1.JobTaskInfo\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/inventory/v1/job-task/get\x12\x80\x01\n" +
	"\x04list\x12'.spaceone.api.inventory.v1.JobTaskQuery\x1a'.spaceone.api.inventory.v1.JobTasksInfo\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/inventory/v1/job-task/list\x12t\n" +
	"\x04stat\x12+.spaceone.api.inventory.v1.JobTaskStatQuery\x1a\x17.google.protobuf.Struct\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/inventory/v1/job-task/statB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
