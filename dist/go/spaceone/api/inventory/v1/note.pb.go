...
const file_spaceone_api_inventory_v1_note_proto_rawDesc = "" +
	"\n" +
	"$spaceone/api/inventory/v1/note.proto\x12\x19spaceone.api.inventory.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"D\n" +
	...
	"\anote_id\x18\x01 \x01(\tR\x06noteId\"\xff\x01\n" +
	"\tNoteQuery\x121\n" +
	...
	"\n" +
	"created_at\x18\x1f \x01(\tR\tcreatedAt\"k\n" +
	"\tNotesInfo\x12=\n" +
	"\aresults\x18\x01 \x03(\v2#.spaceone.api.inventory.v1.NoteInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"L\n" +
	"\rNoteStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xdc\x05\n" +
	"\x04Note\x12\x81\x01\n" +
	"\x06create\x12,.spaceone.api.inventory.v1.CreateNoteRequest\x1a#.spaceone.api.inventory.v1.NoteInfo\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/inventory/v1/note/create\x12\x81\x01\n" +
	"\x06update\x12,.spaceone.api.inventory.v1.UpdateNoteRequest\x1a#.spaceone.api.inventory.v1.NoteInfo\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/inventory/v1/note/update\x12n\n" +
	"\x06delete\x12&.spaceone.api.inventory.v1.NoteRequest\x1a\x16.google.protobuf.Empty\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/inventory/v1/note/delete\x12u\n" +
	"\x03get\x12&.spaceone.api.inventory.v1.NoteRequest\x1a#.spaceone.api.inventory.v1.NoteInfo\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/inventory/v1/note/get\x12v\n" +
	"\x04list\x12$.spaceone.api.inventory.v1.NoteQuery\x1a$.spaceone.api.inventory.v1.NotesInfo\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/inventory/v1/note/list\x12m\n" +
	"\x04stat\x12(.spaceone.api.inventory.v1.NoteStatQuery\x1a\x17.google.protobuf.Struct\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/inventory/v1/note/statB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
