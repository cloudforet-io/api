...
var file_spaceone_api_inventory_v1_note_proto_depIdxs = []int32{
	7,  // 0: spaceone.api.inventory.v1.NoteQuery.query:type_name -> spaceone.api.core.v1.Query
	4,  // 1: spaceone.api.inventory.v1.NotesInfo.results:type_name -> spaceone.api.inventory.v1.NoteInfo
	8,  // 2: spaceone.api.inventory.v1.NoteStatQuery.query:type_name -> spaceone.api.core.v1.StatisticsQuery
