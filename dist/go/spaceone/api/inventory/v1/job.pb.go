...
const file_spaceone_api_inventory_v1_job_proto_rawDesc = "" +
	"\n" +
	"#spaceone/api/inventory/v1/job.proto\x12\x19spaceone.api.inventory.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"#\n" +
	"\n" +
	"JobRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\"\xe7\x02\n" +
	"\tJobsQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12\x15\n" +
	"\x06job_id\x18\x02 \x01(\tR\x05jobId\x12F\n" +
	"\x06status\x18\x03 \x01(\x0e2..spaceone.api.inventory.v1.JobsQuery.JobStatusR\x06status\x12!\n" +
	...
	"\aTIMEOUT\x10\x06\"\x9d\x06\n" +
	"\aJobInfo\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12A\n" +
	"\x06status\x18\x02 \x01(\x0e2).spaceone.api.inventory.v1.JobInfo.StatusR\x06status\x12\x1f\n" +
	"\vtotal_tasks\x18\x04 \x01(\x05R\n" +
	"totalTasks\x12%\n" +
	"\x0eremained_tasks\x18\x05 \x01(\x05R\rremainedTasks\x12#\n" +
	"\rsuccess_tasks\x18\x06 \x01(\x05R\fsuccessTasks\x12#\n" +
	"\rfailure_tasks\x18\a \x01(\x05R\ffailureTasks\x12*\n" +
	"\x11request_secret_id\x18\b \x01(\tR\x0frequestSecretId\x120\n" +
	"\x14request_workspace_id\x18\t \x01(\tR\x12requestWorkspaceId\x12W\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e20.spaceone.api.inventory.v1.JobInfo.ResourceGroupR\rresourceGroup\x12\x1b\n" +
	...
	"\tWORKSPACE\x10\x02\"i\n" +
	"\bJobsInfo\x12<\n" +
	"\aresults\x18\x01 \x03(\v2\".spaceone.api.inventory.v1.JobInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"K\n" +
	"\x0fJobAnalyzeQuery\x128\n" +
	"\x05query\x18\x01 \x01(\v2\".spaceone.api.core.v2.AnalyzeQueryR\x05query\"K\n" +
	"\fJobStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xc0\x04\n" +
	"\x03Job\x12l\n" +
	"\x06delete\x12%.spaceone.api.inventory.v1.JobRequest\x1a\x16.google.protobuf.Empty\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/inventory/v1/job/delete\x12r\n" +
	"\x03get\x12%.spaceone.api.inventory.v1.JobRequest\x1a\".spaceone.api.inventory.v1.JobInfo\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/inventory/v1/job/get\x12t\n" +
	"\x04list\x12$.spaceone.api.inventory.v1.JobsQuery\x1a#.spaceone.api.inventory.v1.JobsInfo\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/inventory/v1/job/list\x12t\n" +
	"\aanalyze\x12*.spaceone.api.inventory.v1.JobAnalyzeQuery\x1a\x17.google.protobuf.Struct\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/inventory/v1/job/analyze\x12k\n" +
	"\x04stat\x12'.spaceone.api.inventory.v1.JobStatQuery\x1a\x17.google.protobuf.Struct\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/inventory/v1/job/statB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
