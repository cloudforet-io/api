...
const file_spaceone_api_inventory_v1_metric_example_proto_rawDesc = "" +
	"\n" +
	".spaceone/api/inventory/v1/metric_example.proto\x12\x19spaceone.api.inventory.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"\xad\x01\n" +
	...
	"\x12MetricExamplesInfo\x12F\n" +
	"\aresults\x18\x01 \x03(\v2,.spaceone.api.inventory.v1.MetricExampleInfoR\aresults\x12\x1f\n" +
	...
	"\x06create\x125.spaceone.api.inventory.v1.CreateMetricExampleRequest\x1a,.spaceone.api.inventory.v1.MetricExampleInfo\".\x82\xd3\xe4\x93\x02(:\x01*\"#/inventory/v1/metric-example/create\x12\x9d\x01\n" +
	"\x06update\x125.spaceone.api.inventory.v1.UpdateMetricExampleRequest\x1a,.spaceone.api.inventory.v1.MetricExampleInfo\".\x82\xd3\xe4\x93\x02(:\x01*\"#/inventory/v1/metric-example/update\x12\x81\x01\n" +
	"\x06delete\x12/.spaceone.api.inventory.v1.MetricExampleRequest\x1a\x16.google.protobuf.Empty\".\x82\xd3\xe4\x93\x02(:\x01*\"#/inventory/v1/metric-example/delete\x12\x91\x01\n" +
	"\x03get\x12/.spaceone.api.inventory.v1.MetricExampleRequest\x1a,.spaceone.api.inventory.v1.MetricExampleInfo\"+\x82\xd3\xe4\x93\x02%:\x01*\" /inventory/v1/metric-example/get\x12\x92\x01\n" +
	"\x04list\x12-.spaceone.api.inventory.v1.MetricExampleQuery\x1a-.spaceone.api.inventory.v1.MetricExamplesInfo\",\x82\xd3\xe4\x93\x02&:\x01*\"!/inventory/v1/metric-example/list\x12\x80\x01\n" +
	"\x04stat\x121.spaceone.api.inventory.v1.MetricExampleStatQuery\x1a\x17.google.protobuf.Struct\",\x82\xd3\xe4\x93\x02&:\x01*\"!/inventory/v1/metric-example/statB@Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1b\x06proto3"
