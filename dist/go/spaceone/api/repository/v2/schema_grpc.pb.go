...
const (
	Schema_Create_FullMethodName = "/spaceone.api.repository.v2.Schema/create"
	Schema_Update_FullMethodName = "/spaceone.api.repository.v2.Schema/update"
	Schema_Sync_FullMethodName   = "/spaceone.api.repository.v2.Schema/sync"
	Schema_Delete_FullMethodName = "/spaceone.api.repository.v2.Schema/delete"
	Schema_Get_FullMethodName    = "/spaceone.api.repository.v2.Schema/get"
	Schema_List_FullMethodName   = "/spaceone.api.repository.v2.Schema/list"
	Schema_Stat_FullMethodName   = "/spaceone.api.repository.v2.Schema/stat"
)
...
type SchemaClient interface {
	...
	Sync(ctx context.Context, in *SchemaRequest, opts ...grpc.CallOption) (*SchemaInfo, error)
	Delete(ctx context.Context, in *SchemaRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	Get(ctx context.Context, in *GetSchemaRequest, opts ...grpc.CallOption) (*SchemaInfo, error)
...
func (c *schemaClient) Sync(ctx context.Context, in *SchemaRequest, opts ...grpc.CallOption) (*SchemaInfo, error) {
	out := new(SchemaInfo)
	err := c.cc.Invoke(ctx, Schema_Sync_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schemaClient) Get(ctx context.Context, in *GetSchemaRequest, opts ...grpc.CallOption) (*SchemaInfo, error) {
	out := new(SchemaInfo)
...
type SchemaServer interface {
	...
	Sync(context.Context, *SchemaRequest) (*SchemaInfo, error)
	Delete(context.Context, *SchemaRequest) (*empty.Empty, error)
	Get(context.Context, *GetSchemaRequest) (*SchemaInfo, error)
...
func (UnimplementedSchemaServer) Sync(context.Context, *SchemaRequest) (*SchemaInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sync not implemented")
}
func (UnimplementedSchemaServer) Delete(context.Context, *SchemaRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedSchemaServer) Get(context.Context, *GetSchemaRequest) (*SchemaInfo, error) {
...
func _Schema_Sync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SchemaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchemaServer).Sync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Schema_Sync_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchemaServer).Sync(ctx, req.(*SchemaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Schema_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchemaServer).Get(ctx, req.(*GetSchemaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Schema_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.repository.v2.Schema",
	...
	Metadata: "spaceone/api/repository/v2/schema.proto",
}
