...
func (c *secretClient) UpdateData(ctx context.Context, in *UpdateSecretDataRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, Secret_UpdateData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretClient) GetData(ctx context.Context, in *GetSecretDataRequest, opts ...grpc.CallOption) (*SecretDataInfo, error) {
	...
	err := c.cc.Invoke(ctx, Secret_GetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretClient) Stat(ctx context.Context, in *SecretStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, Secret_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
