...
const file_spaceone_api_secret_v1_secret_proto_rawDesc = "" +
	"\n" +
	"#spaceone/api/secret/v1/secret.proto\x12\x16spaceone.api.secret.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"\xf0\x03\n" +
	...
	"\x04tags\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x04tags\x12`\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e29.spaceone.api.secret.v1.CreateSecretRequest.ResourceGroupR\rresourceGroup\x12!\n" +
	...
	"\rSecretRequest\x12\x1b\n" +
	"\tsecret_id\x18\x01 \x01(\tR\bsecretId\"P\n" +
	"\x14GetSecretDataRequest\x12\x1b\n" +
	"\tsecret_id\x18\x01 \x01(\tR\bsecretId\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\"\x80\x01\n" +
	"\x17UpdateSecretDataRequest\x12\x1b\n" +
	"\tsecret_id\x18\x01 \x01(\tR\bsecretId\x12\x1b\n" +
	"\tschema_id\x18\x02 \x01(\tR\bschemaId\x12+\n" +
	"\x04data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x04data\"\xbb\x03\n" +
	"\vSecretQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12\x1b\n" +
	"\tsecret_id\x18\x02 \x01(\tR\bsecretId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12?\n" +
	"\x05state\x18\x04 \x01(\x0e2).spaceone.api.secret.v1.SecretQuery.StateR\x05state\x12\x1b\n" +
	"\tschema_id\x18\x05 \x01(\tR\bschemaId\x12\x1a\n" +
	...
	"\x12service_account_id\x18\x17 \x01(\tR\x10serviceAccountId\x12*\n" +
	"\x11trusted_secret_id\x18\x18 \x01(\tR\x0ftrustedSecretId\"2\n" +
	"\x05State\x12\x0e\n" +
	"\n" +
	"STATE_NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\"\x9d\x01\n" +
	"\x0eSecretDataInfo\x12\x1c\n" +
	...
	"\x04data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x04data\"\x9a\x05\n" +
	"\n" +
	"SecretInfo\x12\x1b\n" +
	"\tsecret_id\x18\x01 \x01(\tR\bsecretId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12>\n" +
	"\x05state\x18\x03 \x01(\x0e2(.spaceone.api.secret.v1.SecretInfo.StateR\x05state\x12\x1b\n" +
	"\tschema_id\x18\x04 \x01(\tR\bschemaId\x12\x1a\n" +
	"\bprovider\x18\x05 \x01(\tR\bprovider\x12+\n" +
	"\x04tags\x18\x06 \x01(\v2\x17.google.protobuf.StructR\x04tags\x12W\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e20.spaceone.api.secret.v1.SecretInfo.ResourceGroupR\rresourceGroup\x12\x1b\n" +
	...
	"\x11trusted_secret_id\x18\x19 \x01(\tR\x0ftrustedSecretId\x12\x1d\n" +
	"\n" +
	"created_at\x18\x1f \x01(\tR\tcreatedAt\"2\n" +
	"\x05State\x12\x0e\n" +
	"\n" +
	"STATE_NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	...
	"\aPROJECT\x10\x03\"l\n" +
	"\vSecretsInfo\x12<\n" +
	"\aresults\x18\x01 \x03(\v2\".spaceone.api.secret.v1.SecretInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"k\n" +
	"\x0fSecretStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query\x12\x1b\n" +
	"\tdomain_id\x18\x02 \x01(\tR\bdomainId2\xa9\t\n" +
	"\x06Secret\x12~\n" +
	"\x06create\x12+.spaceone.api.secret.v1.CreateSecretRequest\x1a\".spaceone.api.secret.v1.SecretInfo\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/secret/v1/secret/create\x12~\n" +
	"\x06update\x12+.spaceone.api.secret.v1.UpdateSecretRequest\x1a\".spaceone.api.secret.v1.SecretInfo\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/secret/v1/secret/update\x12l\n" +
	"\x06delete\x12%.spaceone.api.secret.v1.SecretRequest\x1a\x16.google.protobuf.Empty\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/secret/v1/secret/delete\x12x\n" +
	"\x06enable\x12%.spaceone.api.secret.v1.SecretRequest\x1a\".spaceone.api.secret.v1.SecretInfo\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/secret/v1/secret/enable\x12z\n" +
	"\adisable\x12%.spaceone.api.secret.v1.SecretRequest\x1a\".spaceone.api.secret.v1.SecretInfo\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/secret/v1/secret/disable\x12\x80\x01\n" +
	"\vupdate_data\x12/.spaceone.api.secret.v1.UpdateSecretDataRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/secret/v1/secret/update-data\x12b\n" +
	"\bget_data\x12,.spaceone.api.secret.v1.GetSecretDataRequest\x1a&.spaceone.api.secret.v1.SecretDataInfo\"\x00\x12r\n" +
	"\x03get\x12%.spaceone.api.secret.v1.SecretRequest\x1a\".spaceone.api.secret.v1.SecretInfo\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/secret/v1/secret/get\x12s\n" +
	"\x04list\x12#.spaceone.api.secret.v1.SecretQuery\x1a#.spaceone.api.secret.v1.SecretsInfo\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/secret/v1/secret/list\x12k\n" +
	"\x04stat\x12'.spaceone.api.secret.v1.SecretStatQuery\x1a\x17.google.protobuf.Struct\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/secret/v1/secret/statB=Z;github.com/cloudforet-io/api/dist/go/spaceone/api/secret/v1b\x06proto3"

var (
	file_spaceone_api_secret_v1_secret_proto_rawDescOnce sync.Once
	file_spaceone_api_secret_v1_secret_proto_rawDescData []byte
)
...
func file_spaceone_api_secret_v1_secret_proto_rawDescGZIP() []byte {
	file_spaceone_api_secret_v1_secret_proto_rawDescOnce.Do(func() {
		file_spaceone_api_secret_v1_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_secret_v1_secret_proto_rawDesc), len(file_spaceone_api_secret_v1_secret_proto_rawDesc)))
	})
...
func file_spaceone_api_secret_v1_secret_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_secret_v1_secret_proto_rawDesc), len(file_spaceone_api_secret_v1_secret_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
