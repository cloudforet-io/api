...
func (c *trustedSecretClient) Create(ctx context.Context, in *CreateTrustedSecretRequest, opts ...grpc.CallOption) (*TrustedSecretInfo, error) {
	...
	err := c.cc.Invoke(ctx, TrustedSecret_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) Update(ctx context.Context, in *UpdateTrustedSecretRequest, opts ...grpc.CallOption) (*TrustedSecretInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TrustedSecretInfo)
	err := c.cc.Invoke(ctx, TrustedSecret_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) Delete(ctx context.Context, in *TrustedSecretRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, TrustedSecret_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) UpdateData(ctx context.Context, in *UpdateTrustedSecretDataRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, TrustedSecret_UpdateData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) GetData(ctx context.Context, in *GetTrustedSecretDataRequest, opts ...grpc.CallOption) (*TrustedSecretDataInfo, error) {
	...
	err := c.cc.Invoke(ctx, TrustedSecret_GetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) Get(ctx context.Context, in *TrustedSecretRequest, opts ...grpc.CallOption) (*TrustedSecretInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TrustedSecretInfo)
	err := c.cc.Invoke(ctx, TrustedSecret_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) List(ctx context.Context, in *TrustedSecretQuery, opts ...grpc.CallOption) (*TrustedSecretsInfo, error) {
	...
	err := c.cc.Invoke(ctx, TrustedSecret_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trustedSecretClient) Stat(ctx context.Context, in *TrustedSecretStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, TrustedSecret_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTrustedSecretServer must be embedded to have
...
func (UnimplementedTrustedSecretServer) testEmbeddedByValue()                       {}
...
func RegisterTrustedSecretServer(s grpc.ServiceRegistrar, srv TrustedSecretServer) {
	// If the following call pancis, it indicates UnimplementedTrustedSecretServer was
