...
func file_spaceone_api_plugin_v1_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_spaceone_api_plugin_v1_plugin_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_spaceone_api_plugin_v1_plugin_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
