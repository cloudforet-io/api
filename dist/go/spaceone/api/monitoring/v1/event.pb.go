...
const file_spaceone_api_monitoring_v1_event_proto_rawDesc = "" +
	"\n" +
	"&spaceone/api/monitoring/v1/event.proto\x12\x1aspaceone.api.monitoring.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"\x7f\n" +
	...
	"\timage_url\x18\b \x01(\tR\bimageUrl\x12\x1c\n" +
	"\tresources\x18\t \x03(\tR\tresources\x12\x1a\n" +
	"\bprovider\x18\n" +
	" \x01(\tR\bprovider\x12\x18\n" +
	"\aaccount\x18\v \x01(\tR\aaccount\x12@\n" +
	"\x0fadditional_info\x18\f \x01(\v2\x17.google.protobuf.StructR\x0eadditionalInfo\x122\n" +
	"\braw_data\x18\r \x01(\v2\x17.google.protobuf.StructR\arawData\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\x12!\n" +
	"\fworkspace_id\x18\x16 \x01(\tR\vworkspaceId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x17 \x01(\tR\tprojectId\x12\x19\n" +
	"\balert_id\x18\x18 \x01(\tR\aalertId\x12\x1d\n" +
	"\n" +
	"webhook_id\x18\x19 \x01(\tR\twebhookId\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"EventsInfo\x12?\n" +
	"\aresults\x18\x01 \x03(\v2%.spaceone.api.monitoring.v1.EventInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"M\n" +
	"\x0eEventStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xc9\x03\n" +
	"\x05Event\x12R\n" +
	"\x06create\x12..spaceone.api.monitoring.v1.CreateEventRequest\x1a\x16.google.protobuf.Empty\"\x00\x12{\n" +
	"\x03get\x12(.spaceone.api.monitoring.v1.EventRequest\x1a%.spaceone.api.monitoring.v1.EventInfo\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/monitoring/v1/event/get\x12|\n" +
	"\x04list\x12&.spaceone.api.monitoring.v1.EventQuery\x1a&.spaceone.api.monitoring.v1.EventsInfo\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/monitoring/v1/event/list\x12q\n" +
	"\x04stat\x12*.spaceone.api.monitoring.v1.EventStatQuery\x1a\x17.google.protobuf.Struct\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/monitoring/v1/event/statBAZ?github.com/cloudforet-io/api/dist/go/spaceone/api/monitoring/v1b\x06proto3"
