...
const file_spaceone_api_monitoring_v1_log_proto_rawDesc = "" +
	"\n" +
	"$spaceone/api/monitoring/v1/log.proto\x12\x1aspaceone.api.monitoring.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\"\xd8\x01\n" +
	"\n" +
	"LogRequest\x12$\n" +
	"\x0edata_source_id\x18\x01 \x01(\tR\fdataSourceId\x12\x1f\n" +
	"\vresource_id\x18\x02 \x01(\tR\n" +
	"resourceId\x12\x18\n" +
	"\akeyword\x18\x03 \x01(\tR\akeyword\x12\x14\n" +
	"\x05start\x18\n" +
	" \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\v \x01(\tR\x03end\x12+\n" +
	"\x04sort\x18\x0f \x01(\v2\x17.google.protobuf.StructR\x04sort\x12\x14\n" +
	"\x05limit\x18\x10 \x01(\x05R\x05limit\"`\n" +
	"\vLogDataInfo\x124\n" +
	"\aresults\x18\x01 \x01(\v2\x1a.google.protobuf.ListValueR\aresults\x12\x1b\n" +
	"\tdomain_id\x18\x02 \x01(\tR\bdomainId2\x82\x01\n" +
	"\x03Log\x12{\n" +
	"\x04list\x12&.spaceone.api.monitoring.v1.LogRequest\x1a'.spaceone.api.monitoring.v1.LogDataInfo\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/monitoring/v1/log/listBAZ?github.com/cloudforet-io/api/dist/go/spaceone/api/monitoring/v1b\x06proto3"

var (
	file_spaceone_api_monitoring_v1_log_proto_rawDescOnce sync.Once
	file_spaceone_api_monitoring_v1_log_proto_rawDescData []byte
)
...
func file_spaceone_api_monitoring_v1_log_proto_rawDescGZIP() []byte {
	file_spaceone_api_monitoring_v1_log_proto_rawDescOnce.Do(func() {
		file_spaceone_api_monitoring_v1_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_monitoring_v1_log_proto_rawDesc), len(file_spaceone_api_monitoring_v1_log_proto_rawDesc)))
	})
...
func file_spaceone_api_monitoring_v1_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_monitoring_v1_log_proto_rawDesc), len(file_spaceone_api_monitoring_v1_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
