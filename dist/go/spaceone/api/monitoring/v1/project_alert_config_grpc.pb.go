...
// UnimplementedProjectAlertConfigServer must be embedded to have
...
func (UnimplementedProjectAlertConfigServer) testEmbeddedByValue()                            {}
...
func RegisterProjectAlertConfigServer(s grpc.ServiceRegistrar, srv ProjectAlertConfigServer) {
	// If the following call pancis, it indicates UnimplementedProjectAlertConfigServer was
