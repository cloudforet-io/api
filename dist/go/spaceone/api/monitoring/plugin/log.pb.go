...
func file_spaceone_api_monitoring_plugin_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_monitoring_plugin_log_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Sort); i {
			case 0:
				return &v.state
			case 1:
		...
		file_spaceone_api_monitoring_plugin_log_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_monitoring_plugin_log_proto_msgTypes[2].Exporter = func(v any, i int) any {
