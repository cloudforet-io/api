...
// UnimplementedUserSecretServer must be embedded to have
...
func (UnimplementedUserSecretServer) testEmbeddedByValue()                    {}
...
func RegisterUserSecretServer(s grpc.ServiceRegistrar, srv UserSecretServer) {
	// If the following call pancis, it indicates UnimplementedUserSecretServer was
