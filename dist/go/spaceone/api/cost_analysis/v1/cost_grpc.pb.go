...
func (c *costClient) Create(ctx context.Context, in *CreateCostRequest, opts ...grpc.CallOption) (*CostInfo, error) {
	...
	out := new(CostInfo)
	err := c.cc.Invoke(ctx, Cost_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *costClient) Delete(ctx context.Context, in *CostRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, Cost_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *costClient) Get(ctx context.Context, in *CostRequest, opts ...grpc.CallOption) (*CostInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CostInfo)
	err := c.cc.Invoke(ctx, Cost_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *costClient) List(ctx context.Context, in *CostQuery, opts ...grpc.CallOption) (*CostsInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CostsInfo)
	err := c.cc.Invoke(ctx, Cost_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *costClient) Analyze(ctx context.Context, in *CostAnalyzeQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, Cost_Analyze_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *costClient) Stat(ctx context.Context, in *CostStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(_struct.Struct)
	err := c.cc.Invoke(ctx, Cost_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
