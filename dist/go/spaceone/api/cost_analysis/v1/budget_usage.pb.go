...
var file_spaceone_api_cost_analysis_v1_budget_usage_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x69, 0x6d,
...
func file_spaceone_api_cost_analysis_v1_budget_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_cost_analysis_v1_budget_usage_proto_msgTypes[5].Exporter = func(v any, i int) any {
