...
// UnimplementedDataSourceRuleServer must be embedded to have
...
func (UnimplementedDataSourceRuleServer) testEmbeddedByValue()                        {}
...
func RegisterDataSourceRuleServer(s grpc.ServiceRegistrar, srv DataSourceRuleServer) {
	// If the following call pancis, it indicates UnimplementedDataSourceRuleServer was
