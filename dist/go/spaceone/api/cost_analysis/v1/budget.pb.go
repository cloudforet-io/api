...
const file_spaceone_api_cost_analysis_v1_budget_proto_rawDesc = "" +
	...
	"\x05limit\x18\x02 \x01(\x02R\x05limit\"\xef\x02\n" +
	"\x12BudgetNotification\x12\x1c\n" +
	"\tthreshold\x18\x01 \x01(\x02R\tthreshold\x12J\n" +
	"\x04unit\x18\x02 \x01(\x0e26.spaceone.api.cost_analysis.v1.BudgetNotification.UnitR\x04unit\x12o\n" +
	"\x11notification_type\x18\x03 \x01(\x0e2B.spaceone.api.cost_analysis.v1.BudgetNotification.NotificationTypeR\x10notificationType\"3\n" +
	"\x04Unit\x12\r\n" +
	"\tUNIT_NONE\x10\x00\x12\v\n" +
	"\aPERCENT\x10\x01\x12\x0f\n" +
	"\vACTUAL_COST\x10\x02\"I\n" +
	"\x10NotificationType\x12\x1a\n" +
	"\x16NOTIFICATION_TYPE_NONE\x10\x00\x12\f\n" +
	"\bCRITICAL\x10\x01\x12\v\n" +
	"\aWARNING\x10\x02\"\xad\x01\n" +
	"\x0eProviderFilter\x12I\n" +
	"\x05state\x18\x01 \x01(\x0e23.spaceone.api.cost_analysis.v1.ProviderFilter.StateR\x05state\x12\x1c\n" +
	"\tproviders\x18\x02 \x03(\tR\tproviders\"2\n" +
	"\x05State\x12\x0e\n" +
	"\n" +
	"STATE_NONE\x10\x00\x12\v\n" +
	"\aENABLED\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\"\xb8\x06\n" +
	"\x13CreateBudgetRequest\x12$\n" +
	"\x0edata_source_id\x18\x01 \x01(\tR\fdataSourceId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x02R\x05limit\x12R\n" +
	"\x0eplanned_limits\x18\x04 \x03(\v2+.spaceone.api.cost_analysis.v1.PlannedLimitR\rplannedLimits\x12V\n" +
	"\x0fprovider_filter\x18\x05 \x01(\v2-.spaceone.api.cost_analysis.v1.ProviderFilterR\x0eproviderFilter\x12X\n" +
	...
	"\rnotifications\x18\t \x03(\v21.spaceone.api.cost_analysis.v1.BudgetNotificationR\rnotifications\x12+\n" +
	"\x04tags\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\x04tags\x12g\n" +
	...
	"\rnotifications\x18\x02 \x03(\v21.spaceone.api.cost_analysis.v1.BudgetNotificationR\rnotifications\",\n" +
	"\rBudgetRequest\x12\x1b\n" +
	"\tbudget_id\x18\x01 \x01(\tR\bbudgetId\"\xd9\x02\n" +
	"\vBudgetQuery\x121\n" +
	...
	"\x0edata_source_id\x18\x17 \x01(\tR\fdataSourceId\",\n" +
	"\bTimeUnit\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05TOTAL\x10\x01\x12\v\n" +
	"\aMONTHLY\x10\x02\"\xb1\a\n" +
	"\n" +
	"BudgetInfo\x12\x1b\n" +
	"\tbudget_id\x18\x01 \x01(\tR\bbudgetId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	...
	"\bcurrency\x18\x05 \x01(\tR\bcurrency\x12V\n" +
	"\x0fprovider_filter\x18\x06 \x01(\v2-.spaceone.api.cost_analysis.v1.ProviderFilterR\x0eproviderFilter\x12O\n" +
	...
	"\x03end\x18\t \x01(\tR\x03end\x12W\n" +
	"\rnotifications\x18\n" +
	" \x03(\v21.spaceone.api.cost_analysis.v1.BudgetNotificationR\rnotifications\x12+\n" +
	...
	"\x0edata_source_id\x18\x18 \x01(\tR\fdataSourceId\x12\x1d\n" +
	"\n" +
