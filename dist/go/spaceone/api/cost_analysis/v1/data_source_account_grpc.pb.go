...
func (c *dataSourceAccountClient) Update(ctx context.Context, in *UpdateDataSourceAccountRequest, opts ...grpc.CallOption) (*DataSourceAccountInfo, error) {
	...
	err := c.cc.Invoke(ctx, DataSourceAccount_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceAccountClient) Reset(ctx context.Context, in *ResetDataSourceAccountRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, DataSourceAccount_Reset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceAccountClient) Get(ctx context.Context, in *DataSourceAccountRequest, opts ...grpc.CallOption) (*DataSourceAccountInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DataSourceAccountInfo)
	err := c.cc.Invoke(ctx, DataSourceAccount_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceAccountClient) List(ctx context.Context, in *DataSourceAccountQuery, opts ...grpc.CallOption) (*DataSourceAccountsInfo, error) {
	...
	err := c.cc.Invoke(ctx, DataSourceAccount_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceAccountClient) Analyze(ctx context.Context, in *DataSourceAccountAnalyzeQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	...
	err := c.cc.Invoke(ctx, DataSourceAccount_Analyze_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceAccountClient) Stat(ctx context.Context, in *DataSourceAccountStatQuery, opts ...grpc.CallOption) (*_struct.Struct, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(_struct.Struct)
	err := c.cc.Invoke(ctx, DataSourceAccount_Stat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDataSourceAccountServer must be embedded to have
...
func (UnimplementedDataSourceAccountServer) testEmbeddedByValue()                           {}
...
func RegisterDataSourceAccountServer(s grpc.ServiceRegistrar, srv DataSourceAccountServer) {
	// If the following call pancis, it indicates UnimplementedDataSourceAccountServer was
