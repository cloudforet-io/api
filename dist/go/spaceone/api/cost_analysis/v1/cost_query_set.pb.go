...
const file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDesc = "" +
	"\n" +
	"2spaceone/api/cost_analysis/v1/cost_query_set.proto\x12\x1dspaceone.api.cost_analysis.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"\xb5\x01\n" +
	"\x19CreateCostQuerySetRequest\x12$\n" +
	...
	"\x04tags\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x04tags\"\xba\x01\n" +
	"\x19UpdateCostQuerySetRequest\x12)\n" +
	"\x11cost_query_set_id\x18\x01 \x01(\tR\x0ecostQuerySetId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x121\n" +
	"\aoptions\x18\x03 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12+\n" +
	"\x04tags\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x04tags\"@\n" +
	"\x13CostQuerySetRequest\x12)\n" +
	"\x11cost_query_set_id\x18\x01 \x01(\tR\x0ecostQuerySetId\"\x80\x01\n" +
	"\x11CostQuerySetQuery\x121\n" +
	...
	"\n" +
	"updated_at\x18  \x01(\tR\tupdatedAt\"\x7f\n" +
	"\x11CostQuerySetsInfo\x12I\n" +
	"\aresults\x18\x01 \x03(\v2/.spaceone.api.cost_analysis.v1.CostQuerySetInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"z\n" +
	"\x15CostQuerySetStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query\x12$\n" +
	"\x0edata_source_id\x18\x02 \x01(\tR\fdataSourceId2\xb4\a\n" +
	"\fCostQuerySet\x12\xa7\x01\n" +
	"\x06create\x128.spaceone.api.cost_analysis.v1.CreateCostQuerySetRequest\x1a/.spaceone.api.cost_analysis.v1.CostQuerySetInfo\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/cost-analysis/v1/cost-query-set/create\x12\xa7\x01\n" +
	"\x06update\x128.spaceone.api.cost_analysis.v1.UpdateCostQuerySetRequest\x1a/.spaceone.api.cost_analysis.v1.CostQuerySetInfo\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/cost-analysis/v1/cost-query-set/update\x12\x88\x01\n" +
	"\x06delete\x122.spaceone.api.cost_analysis.v1.CostQuerySetRequest\x1a\x16.google.protobuf.Empty\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/cost-analysis/v1/cost-query-set/delete\x12\x9b\x01\n" +
	"\x03get\x122.spaceone.api.cost_analysis.v1.CostQuerySetRequest\x1a/.spaceone.api.cost_analysis.v1.CostQuerySetInfo\"/\x82\xd3\xe4\x93\x02):\x01*\"$/cost-analysis/v1/cost-query-set/get\x12\x9c\x01\n" +
	"\x04list\x120.spaceone.api.cost_analysis.v1.CostQuerySetQuery\x1a0.spaceone.api.cost_analysis.v1.CostQuerySetsInfo\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/cost-analysis/v1/cost-query-set/list\x12\x87\x01\n" +
	"\x04stat\x124.spaceone.api.cost_analysis.v1.CostQuerySetStatQuery\x1a\x17.google.protobuf.Struct\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/cost-analysis/v1/cost-query-set/statBDZBgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/v1b\x06proto3"

var (
	file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDescOnce sync.Once
	file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDescData []byte
)
...
func file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDescGZIP() []byte {
	file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDescOnce.Do(func() {
		file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDesc), len(file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDesc)))
	})
...
func file_spaceone_api_cost_analysis_v1_cost_query_set_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDesc), len(file_spaceone_api_cost_analysis_v1_cost_query_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
