...
const file_spaceone_api_cost_analysis_v1_data_source_proto_rawDesc = "" +
	...
	"pluginInfo\x12+\n" +
	"\x04tags\x18\b \x01(\v2\x17.google.protobuf.StructR\x04tags\x12m\n" +
	...
	"\btemplate\x18\x04 \x01(\v2\x17.google.protobuf.StructR\btemplate\x12+\n" +
	"\x04tags\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x04tags\"\x85\x01\n" +
	...
	"\x0edata_source_id\x18\x01 \x01(\tR\fdataSourceId\"\xac\x03\n" +
	...
	"\x10data_source_type\x18\x05 \x01(\x0e2=.spaceone.api.cost_analysis.v1.DataSourceQuery.DataSourceTypeR\x0edataSourceType\x12\x1a\n" +
	"\bprovider\x18\x06 \x01(\tR\bprovider\x124\n" +
	"\x16connected_workspace_id\x18\a \x01(\tR\x14connectedWorkspaceId\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\"8\n" +
	"\x0eDataSourceType\x12\r\n" +
	"\tTYPE_NONE\x10\x00\x12\t\n" +
	"\x05LOCAL\x10\x01\x12\f\n" +
	"\bEXTERNAL\x10\x02\"\xc2\v\n" +
	"\x0eDataSourceInfo\x12$\n" +
	"\x0edata_source_id\x18\x01 \x01(\tR\fdataSourceId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12I\n" +
	"\x05state\x18\x03 \x01(\x0e23.spaceone.api.cost_analysis.v1.DataSourceInfo.StateR\x05state\x12f\n" +
	"\x10data_source_type\x18\x04 \x01(\x0e2<.spaceone.api.cost_analysis.v1.DataSourceInfo.DataSourceTypeR\x0edataSourceType\x129\n" +
	"\vpermissions\x18\x05 \x01(\v2\x17.google.protobuf.StructR\vpermissions\x12\x1a\n" +
	"\bprovider\x18\x06 \x01(\tR\bprovider\x12Y\n" +
	"\vsecret_type\x18\a \x01(\x0e28.spaceone.api.cost_analysis.v1.DataSourceInfo.SecretTypeR\n" +
	"secretType\x12P\n" +
	"\rsecret_filter\x18\b \x01(\v2+.spaceone.api.cost_analysis.v1.SecretFilterR\fsecretFilter\x12J\n" +
	"\vplugin_info\x18\t \x01(\v2).spaceone.api.cost_analysis.v1.PluginInfoR\n" +
	"pluginInfo\x123\n" +
	"\btemplate\x18\n" +
	...
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xc8\x10\n" +
	"\n" +
	...
	"\rverify_plugin\x120.spaceone.api.cost_analysis.v1.DataSourceRequest\x1a\x16.google.protobuf.Empty\"6\x82\xd3\xe4\x93\x020:\x01*\"+/cost-analysis/v1/data-source/verify-plugin\x12\x9a\x01\n" +
	"\x06enable\x120.spaceone.api.cost_analysis.v1.DataSourceRequest\x1a-.spaceone.api.cost_analysis.v1.DataSourceInfo\"/\x82\xd3\xe4\x93\x02):\x01*\"$/cost-analysis/v1/data-source/enable\x12\x9c\x01\n" +
	"\adisable\x120.spaceone.api.cost_analysis.v1.DataSourceRequest\x1a-.spaceone.api.cost_analysis.v1.DataSourceInfo\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/cost-analysis/v1/data-source/disable\x12\x95\x01\n" +
	"\n" +
