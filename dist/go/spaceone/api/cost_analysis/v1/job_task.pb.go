...
const file_spaceone_api_cost_analysis_v1_job_task_proto_rawDesc = "" +
	"\n" +
	",spaceone/api/cost_analysis/v1/job_task.proto\x12\x1dspaceone.api.cost_analysis.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\x1a'spaceone/api/cost_analysis/v1/job.proto\"0\n" +
	...
	"\achanged\x18\x04 \x01(\v2*.spaceone.api.cost_analysis.v1.ChangedInfoR\achanged\x12#\n" +
	"\rcreated_count\x18\x05 \x01(\x05R\fcreatedCount\x12\x1d\n" +
	"\n" +
	"error_code\x18\x06 \x01(\tR\terrorCode\x12#\n" +
	"\rerror_message\x18\a \x01(\tR\ferrorMessage\x12_\n" +
