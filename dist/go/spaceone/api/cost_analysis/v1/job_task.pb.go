...
const file_spaceone_api_cost_analysis_v1_job_task_proto_rawDesc = "" +
	"\n" +
	",spaceone/api/cost_analysis/v1/job_task.proto\x12\x1dspaceone.api.cost_analysis.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v2/query.proto\"0\n" +
	"\x0eJobTaskRequest\x12\x1e\n" +
	"\vjob_task_id\x18\x01 \x01(\tR\tjobTaskId\"\xfa\x02\n" +
	"\fJobTaskQuery\x121\n" +
	"\x05query\x18\x01 \x01(\v2\x1b.spaceone.api.core.v2.QueryR\x05query\x12\x1e\n" +
	"\vjob_task_id\x18\x02 \x01(\tR\tjobTaskId\x12J\n" +
	"\x06status\x18\x03 \x01(\x0e22.spaceone.api.cost_analysis.v1.JobTaskQuery.StatusR\x06status\x12!\n" +
	"\fworkspace_id\x18\x15 \x01(\tR\vworkspaceId\x12\x15\n" +
	"\x06job_id\x18\x16 \x01(\tR\x05jobId\x12$\n" +
	"\x0edata_source_id\x18\x17 \x01(\tR\fdataSourceId\"k\n" +
	"\x06Status\x12\x0e\n" +
	"\n" +
	"SCOPE_NONE\x10\x00\x12\v\n" +
	"\aPENDING\x10\x01\x12\x0f\n" +
	"\vIN_PROGRESS\x10\x02\x12\v\n" +
	"\aSUCCESS\x10\x03\x12\v\n" +
	"\aFAILURE\x10\x04\x12\v\n" +
	"\aTIMEOUT\x10\x05\x12\f\n" +
	"\bCANCELED\x10\x06\"\xa2\x06\n" +
	"\vJobTaskInfo\x12\x1e\n" +
	"\vjob_task_id\x18\x01 \x01(\tR\tjobTaskId\x12I\n" +
	"\x06status\x18\x02 \x01(\x0e21.spaceone.api.cost_analysis.v1.JobTaskInfo.StatusR\x06status\x121\n" +
	"\aoptions\x18\x03 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12#\n" +
	"\rcreated_count\x18\x04 \x01(\x05R\fcreatedCount\x12\x1d\n" +
	"\n" +
	"error_code\x18\x05 \x01(\tR\terrorCode\x12#\n" +
	"\rerror_message\x18\x06 \x01(\tR\ferrorMessage\x12_\n" +
	"\x0eresource_group\x18\x14 \x01(\x0e28.spaceone.api.cost_analysis.v1.JobTaskInfo.ResourceGroupR\rresourceGroup\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\x12!\n" +
	"\fworkspace_id\x18\x16 \x01(\tR\vworkspaceId\x12\x15\n" +
	"\x06job_id\x18\x17 \x01(\tR\x05jobId\x12$\n" +
	...
	"\tWORKSPACE\x10\x02\"u\n" +
	"\fJobTasksInfo\x12D\n" +
	"\aresults\x18\x01 \x03(\v2*.spaceone.api.cost_analysis.v1.JobTaskInfoR\aresults\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"O\n" +
	"\x10JobTaskStatQuery\x12;\n" +
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xa4\x03\n" +
	"\aJobTask\x12\x8b\x01\n" +
	"\x03get\x12-.spaceone.api.cost_analysis.v1.JobTaskRequest\x1a*.spaceone.api.cost_analysis.v1.JobTaskInfo\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/cost-analysis/v1/job-task/get\x12\x8c\x01\n" +
	"\x04list\x12+.spaceone.api.cost_analysis.v1.JobTaskQuery\x1a+.spaceone.api.cost_analysis.v1.JobTasksInfo\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/cost-analysis/v1/job-task/list\x12|\n" +
	"\x04stat\x12/.spaceone.api.cost_analysis.v1.JobTaskStatQuery\x1a\x17.google.protobuf.Struct\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/cost-analysis/v1/job-task/statBDZBgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/v1b\x06proto3"
