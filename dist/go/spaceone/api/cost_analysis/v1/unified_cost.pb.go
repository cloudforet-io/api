...
const file_spaceone_api_cost_analysis_v1_unified_cost_proto_rawDesc = "" +
	...
	"\fis_confirmed\x18\x02 \x01(\bR\visConfirmed\"\x8e\a\n" +
	...
	"\fbilled_month\x18\x03 \x01(\tR\vbilledMonth\x12\x1f\n" +
	"\vbilled_year\x18\x04 \x01(\tR\n" +
	"billedYear\x12)\n" +
	"\x10aggregation_date\x18\x05 \x01(\tR\x0faggregationDate\x12#\n" +
	"\rexchange_date\x18\x06 \x01(\tR\fexchangeDate\x12'\n" +
	"\x0fexchange_source\x18\a \x01(\tR\x0eexchangeSource\x12\x1a\n" +
	"\bcurrency\x18\b \x01(\tR\bcurrency\x12!\n" +
	"\fis_confirmed\x18\t \x01(\bR\visConfirmed\x12\x1a\n" +
	"\bprovider\x18\n" +
	" \x01(\tR\bprovider\x12\x1f\n" +
	"\vregion_code\x18\v \x01(\tR\n" +
	"regionCode\x12\x1d\n" +
	"\n" +
	"region_key\x18\f \x01(\tR\tregionKey\x12\x18\n" +
	"\aproduct\x18\r \x01(\tR\aproduct\x12\x1d\n" +
	"\n" +
	"usage_type\x18\x0e \x01(\tR\tusageType\x12\x1d\n" +
	"\n" +
	"usage_unit\x18\x0f \x01(\tR\tusageUnit\x120\n" +
	"\x14service_account_name\x18\x10 \x01(\tR\x12serviceAccountName\x12(\n" +
	"\x10data_source_name\x18\x11 \x01(\tR\x0edataSourceName\x12!\n" +
	"\fproject_name\x18\x12 \x01(\tR\vprojectName\x12%\n" +
	"\x0eworkspace_name\x18\x13 \x01(\tR\rworkspaceName\x12\x1b\n" +
	...
	"\x05query\x18\x01 \x01(\v2%.spaceone.api.core.v2.StatisticsQueryR\x05query2\xd9\x04\n" +
	"\vUnifiedCost\x12\x97\x01\n" +
