...
const (
	Job_GetTasks_FullMethodName = "/spaceone.api.cost_analysis.plugin.Job/get_tasks"
)
...
func (c *jobClient) GetTasks(ctx context.Context, in *GetTasksRequest, opts ...grpc.CallOption) (*TasksInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TasksInfo)
	err := c.cc.Invoke(ctx, Job_GetTasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedJobServer) GetTasks(context.Context, *GetTasksRequest) (*TasksInfo, error) {
...
func _Job_GetTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServer).GetTasks(ctx, req.(*GetTasksRequest))
	}
...
var Job_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spaceone.api.cost_analysis.plugin.Job",
	...
	Metadata: "spaceone/api/cost_analysis/plugin/job.proto",
}
