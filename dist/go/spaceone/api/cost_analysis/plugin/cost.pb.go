...
const file_spaceone_api_cost_analysis_plugin_cost_proto_rawDesc = "" +
	"\n" +
	",spaceone/api/cost_analysis/plugin/cost.proto\x12!spaceone.api.cost_analysis.plugin\x1a\x1cgoogle/protobuf/struct.proto\"\xbc\x01\n" +
	"\x18GetLinkedAccountsRequest\x121\n" +
	"\aoptions\x18\x01 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12\x16\n" +
	"\x06schema\x18\x02 \x01(\tR\x06schema\x128\n" +
	"\vsecret_data\x18\x03 \x01(\v2\x17.google.protobuf.StructR\n" +
	"secretData\x12\x1b\n" +
	"\tdomain_id\x18\x15 \x01(\tR\bdomainId\"\xee\x01\n" +
	...
	"\ftask_options\x18\x04 \x01(\v2\x17.google.protobuf.StructR\vtaskOptions\x12\x1b\n" +
	"\tdomain_id\x18\x05 \x01(\tR\bdomainId\"@\n" +
	...
	"\n" +
	"usage_unit\x18\x03 \x01(\tR\tusageUnit\x12\x1a\n" +
	...
	"\x0fadditional_info\x18\r \x01(\v2\x17.google.protobuf.StructR\x0eadditionalInfo\x12+\n" +
	"\x04data\x18\x0e \x01(\v2\x17.google.protobuf.StructR\x04data\x12\x1f\n" +
	"\vbilled_date\x18\x15 \x01(\tR\n" +
	"billedDate\"X\n" +
	"\fAccountsInfo\x12H\n" +
	"\aresults\x18\x01 \x03(\v2..spaceone.api.cost_analysis.plugin.AccountInfoR\aresults\"R\n" +
	"\tCostsInfo\x12E\n" +
	"\aresults\x18\x01 \x03(\v2+.spaceone.api.cost_analysis.plugin.CostInfoR\aresults2\xff\x01\n" +
	"\x04Cost\x12\x85\x01\n" +
	...
	"\bget_data\x121.spaceone.api.cost_analysis.plugin.GetDataRequest\x1a,.spaceone.api.cost_analysis.plugin.CostsInfo\"\x000\x01BHZFgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/pluginb\x06proto3"
