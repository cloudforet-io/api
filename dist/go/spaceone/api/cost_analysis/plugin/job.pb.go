...
const file_spaceone_api_cost_analysis_plugin_job_proto_rawDesc = "" +
	"\n" +
	"+spaceone/api/cost_analysis/plugin/job.proto\x12!spaceone.api.cost_analysis.plugin\x1a\x1cgoogle/protobuf/struct.proto\"\xbd\x02\n" +
	"\x0fGetTasksRequest\x121\n" +
	...
	"\x05start\x18\x04 \x01(\tR\x05start\x120\n" +
	"\x14last_synchronized_at\x18\x05 \x01(\tR\x12lastSynchronizedAt\x12\x1b\n" +
	"\tdomain_id\x18\x06 \x01(\tR\bdomainId\x12@\n" +
	"\x0flinked_accounts\x18\a \x03(\v2\x17.google.protobuf.StructR\x0elinkedAccounts\"F\n" +
	"\bTaskInfo\x12:\n" +
	"\ftask_options\x18\x01 \x01(\v2\x17.google.protobuf.StructR\vtaskOptions\"f\n" +
	"\vChangedInfo\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\tR\x03end\x12/\n" +
	"\x06filter\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06filter\"F\n" +
	"\x11SyncedAccountInfo\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\xf7\x01\n" +
	"\tTasksInfo\x12A\n" +
	"\x05tasks\x18\x01 \x03(\v2+.spaceone.api.cost_analysis.plugin.TaskInfoR\x05tasks\x12H\n" +
	"\achanged\x18\x02 \x03(\v2..spaceone.api.cost_analysis.plugin.ChangedInfoR\achanged\x12]\n" +
	"\x0fsynced_accounts\x18\x03 \x03(\v24.spaceone.api.cost_analysis.plugin.SyncedAccountInfoR\x0esyncedAccounts2v\n" +
	"\x03Job\x12o\n" +
	"\tget_tasks\x122.spaceone.api.cost_analysis.plugin.GetTasksRequest\x1a,.spaceone.api.cost_analysis.plugin.TasksInfo\"\x00BHZFgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/pluginb\x06proto3"

var (
	file_spaceone_api_cost_analysis_plugin_job_proto_rawDescOnce sync.Once
	file_spaceone_api_cost_analysis_plugin_job_proto_rawDescData []byte
)
...
func file_spaceone_api_cost_analysis_plugin_job_proto_rawDescGZIP() []byte {
	file_spaceone_api_cost_analysis_plugin_job_proto_rawDescOnce.Do(func() {
		file_spaceone_api_cost_analysis_plugin_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_cost_analysis_plugin_job_proto_rawDesc), len(file_spaceone_api_cost_analysis_plugin_job_proto_rawDesc)))
	})
...
func file_spaceone_api_cost_analysis_plugin_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_cost_analysis_plugin_job_proto_rawDesc), len(file_spaceone_api_cost_analysis_plugin_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
