...
var file_spaceone_api_cost_analysis_plugin_data_source_proto_goTypes = []interface{}{
...
func file_spaceone_api_cost_analysis_plugin_data_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_cost_analysis_plugin_data_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_spaceone_api_cost_analysis_plugin_data_source_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_spaceone_api_cost_analysis_plugin_data_source_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
