...
const file_spaceone_api_core_v1_query_proto_rawDesc = "" +
	"\n" +
	" spaceone/api/core/v1/query.proto\x12\x14spaceone.api.core.v1\x1a\x1cgoogle/protobuf/struct.proto\"\xe0\x01\n" +
	"\x06Filter\x12\x12\n" +
	...
	"\x04desc\x18\x02 \x01(\bR\x04desc\"_\n" +
	"\x04Sort\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x12\n" +
	"\x04desc\x18\x02 \x01(\bR\x04desc\x121\n" +
	"\x04keys\x18\x03 \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04keys\"2\n" +
	"\x04Page\x12\x14\n" +
	"\x05start\x18\x01 \x01(\rR\x05start\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\rR\x05limit\"R\n" +
	"\x06Unwind\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x124\n" +
	"\x06filter\x18\x02 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\"\xf5\x02\n" +
	"\x05Query\x124\n" +
	"\x06filter\x18\x01 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\x02 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12.\n" +
	"\x04sort\x18\x03 \x01(\v2\x1a.spaceone.api.core.v1.SortR\x04sort\x12.\n" +
	"\x04page\x18\x04 \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\x12\x18\n" +
	...
	"\x06unwind\x18\t \x01(\v2\x1c.spaceone.api.core.v1.UnwindR\x06unwind\"\x99\x01\n" +
	...
	"\x06fields\x18\a \x03(\v2,.spaceone.api.core.v1.AggregateGroupSubFieldR\x06fields\x12K\n" +
	"\n" +
	"conditions\x18\b \x03(\v2+.spaceone.api.core.v1.AggregateSubConditionR\n" +
	"conditionsB\v\n" +
	"\tkey_aliasB\f\n" +
	"\n" +
	"name_aliasB\x10\n" +
	...
	"\x04keys\x18\x01 \x03(\v2'.spaceone.api.core.v1.AggregateGroupKeyR\x04keys\x12A\n" +
	"\x06fields\x18\x02 \x03(\v2).spaceone.api.core.v1.AggregateGroupFieldR\x06fields\"\xbc\x01\n" +
	...
	"\x06fields\x18\x01 \x03(\v2+.spaceone.api.core.v1.AggregateProjectFieldR\x06fields\x12!\n" +
	"\fexclude_keys\x18\x02 \x01(\bR\vexcludeKeys\"%\n" +
	"\x0fAggregateUnwind\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\"$\n" +
	"\x0eAggregateCount\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"h\n" +
	"\rAggregateSort\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x12\n" +
	"\x04desc\x18\x02 \x01(\bR\x04desc\x121\n" +
	"\x04keys\x18\x03 \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04keys\"\x92\x03\n" +
	"\x13StatisticsAggregate\x12?\n" +
	"\x06unwind\x18\x01 \x01(\v2%.spaceone.api.core.v1.AggregateUnwindH\x00R\x06unwind\x12<\n" +
	"\x05group\x18\x02 \x01(\v2$.spaceone.api.core.v1.AggregateGroupH\x00R\x05group\x12<\n" +
	"\x05count\x18\x03 \x01(\v2$.spaceone.api.core.v1.AggregateCountH\x00R\x05count\x129\n" +
	"\x04sort\x18\x04 \x01(\v2#.spaceone.api.core.v1.AggregateSortH\x00R\x04sort\x12B\n" +
	"\aproject\x18\x05 \x01(\v2&.spaceone.api.core.v1.AggregateProjectH\x00R\aproject\x12\x16\n" +
	...
	"\x06filter\x18\x01 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\x02 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12G\n" +
	"\taggregate\x18\x03 \x03(\v2).spaceone.api.core.v1.StatisticsAggregateR\taggregate\x12.\n" +
	"\x04page\x18\x04 \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\x12\x1a\n" +
	"\bdistinct\x18\x05 \x01(\tR\bdistinct\x12\x18\n" +
	"\akeyword\x18\x06 \x01(\tR\akeyword\"\xf1\x04\n" +
	"\x16TimeSeriesAnalyzeQuery\x12Z\n" +
	"\vgranularity\x18\x01 \x01(\x0e28.spaceone.api.core.v1.TimeSeriesAnalyzeQuery.GranularityR\vgranularity\x12\x14\n" +
	"\x05start\x18\x02 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x03 \x01(\tR\x03end\x12\x19\n" +
	"\bgroup_by\x18\x04 \x03(\tR\agroupBy\x12\x1f\n" +
	"\vfield_group\x18\x05 \x03(\tR\n" +
	"fieldGroup\x124\n" +
	"\x06filter\x18\x06 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\a \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12.\n" +
	"\x04page\x18\b \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\x121\n" +
	"\x04sort\x18\t \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04sort\x12/\n" +
	"\x06fields\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\x06fields\x12/\n" +
	"\x06select\x18\v \x01(\v2\x17.google.protobuf.StructR\x06select\x12\x18\n" +
	"\akeyword\x18\f \x01(\tR\akeyword\"G\n" +
	"\vGranularity\x12\x14\n" +
	"\x10GRANULARITY_NONE\x10\x00\x12\t\n" +
	"\x05DAILY\x10\x01\x12\v\n" +
	"\aMONTHLY\x10\x02\x12\n" +
	"\n" +
	"\x06YEARLY\x10\x03\"\x9a\x03\n" +
	"\fAnalyzeQuery\x12\x19\n" +
	"\bgroup_by\x18\x01 \x03(\tR\agroupBy\x12\x1f\n" +
	"\vfield_group\x18\x02 \x03(\tR\n" +
	"fieldGroup\x124\n" +
	"\x06filter\x18\x03 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\x04 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12.\n" +
	"\x04page\x18\x05 \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\x121\n" +
	"\x04sort\x18\x06 \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04sort\x12/\n" +
	...
	"\akeyword\x18\t \x01(\tR\akeyword\"\xeb\x02\n" +
	"\x11ExportSearchQuery\x124\n" +
	"\x06filter\x18\x01 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\x02 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12\x18\n" +
	"\akeyword\x18\x03 \x01(\tR\akeyword\x121\n" +
	"\x04sort\x18\x04 \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04sort\x122\n" +
	"\x06fields\x18\x05 \x01(\v2\x1a.google.protobuf.ListValueR\x06fields\x124\n" +
	"\x06unwind\x18\x06 \x01(\v2\x1c.spaceone.api.core.v1.UnwindR\x06unwind\x12.\n" +
	"\x04page\x18\a \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\"\xff\x02\n" +
	"\x12ExportAnalyzeQuery\x124\n" +
	"\x06filter\x18\x01 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\x06filter\x129\n" +
	"\tfilter_or\x18\x02 \x03(\v2\x1c.spaceone.api.core.v1.FilterR\bfilterOr\x12\x18\n" +
	"\akeyword\x18\x03 \x01(\tR\akeyword\x121\n" +
	"\x04sort\x18\x04 \x03(\v2\x1d.spaceone.api.core.v1.SortKeyR\x04sort\x12\x19\n" +
	...
	"\x04page\x18\b \x01(\v2\x1a.spaceone.api.core.v1.PageR\x04page\"\xef\x02\n" +
	"\fExportOption\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12K\n" +
	"\n" +
	"query_type\x18\v \x01(\x0e2,.spaceone.api.core.v1.ExportOption.QueryTypeR\tqueryType\x12L\n" +
	"\fsearch_query\x18\f \x01(\v2'.spaceone.api.core.v1.ExportSearchQueryH\x00R\vsearchQuery\x12O\n" +
	"\ranalyze_query\x18\r \x01(\v2(.spaceone.api.core.v1.ExportAnalyzeQueryH\x00R\fanalyzeQuery\"9\n" +
	"\tQueryType\x12\x13\n" +
	"\x0fQUERY_TYPE_NONE\x10\x00\x12\n" +
	"\n" +
	"\x06SEARCH\x10\x01\x12\v\n" +
	"\aANALYZE\x10\x02B\x0e\n" +
	"\fexport_queryB;Z9github.com/cloudforet-io/api/dist/go/spaceone/api/core/v1b\x06proto3"
