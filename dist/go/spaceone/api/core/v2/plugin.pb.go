...
const file_spaceone_api_core_v2_plugin_proto_rawDesc = "" +
	"\n" +
	"!spaceone/api/core/v2/plugin.proto\x12\x14spaceone.api.core.v2\x1a\x1cgoogle/protobuf/struct.proto\"\xd3\x02\n" +
	"\rPluginRequest\x12\x1b\n" +
	"\tplugin_id\x18\x01 \x01(\tR\bpluginId\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12R\n" +
	"\fupgrade_mode\x18\x03 \x01(\x0e2/.spaceone.api.core.v2.PluginRequest.UpgradeModeR\vupgradeMode\x121\n" +
	"\aoptions\x18\x04 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12\x1b\n" +
	"\tschema_id\x18\x05 \x01(\tR\bschemaId\x128\n" +
	"\vsecret_data\x18\x06 \x01(\v2\x17.google.protobuf.StructR\n" +
	"secretData\"-\n" +
	"\vUpgradeMode\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06MANUAL\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\"\xe5\x02\n" +
	"\n" +
	"PluginInfo\x12\x1b\n" +
	"\tplugin_id\x18\x01 \x01(\tR\bpluginId\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12O\n" +
	"\fupgrade_mode\x18\x03 \x01(\x0e2,.spaceone.api.core.v2.PluginInfo.UpgradeModeR\vupgradeMode\x121\n" +
	...
	"\tsecret_id\x18\a \x01(\tR\bsecretId\"-\n" +
	"\vUpgradeMode\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06MANUAL\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02B;Z9github.com/cloudforet-io/api/dist/go/spaceone/api/core/v2b\x06proto3"

var (
	file_spaceone_api_core_v2_plugin_proto_rawDescOnce sync.Once
	file_spaceone_api_core_v2_plugin_proto_rawDescData []byte
)

func file_spaceone_api_core_v2_plugin_proto_rawDescGZIP() []byte {
	file_spaceone_api_core_v2_plugin_proto_rawDescOnce.Do(func() {
		file_spaceone_api_core_v2_plugin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spaceone_api_core_v2_plugin_proto_rawDesc), len(file_spaceone_api_core_v2_plugin_proto_rawDesc)))
	})
...
func file_spaceone_api_core_v2_plugin_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spaceone_api_core_v2_plugin_proto_rawDesc), len(file_spaceone_api_core_v2_plugin_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
