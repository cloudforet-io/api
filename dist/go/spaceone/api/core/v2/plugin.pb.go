...
func file_spaceone_api_core_v2_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spaceone_api_core_v2_plugin_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_spaceone_api_core_v2_plugin_proto_msgTypes[1].Exporter = func(v any, i int) any {
