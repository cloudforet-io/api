...
var file_spaceone_api_statistics_v1_resource_proto_depIdxs = []int32{
	10, // 0: spaceone.api.statistics.v1.StatAggregateQuery.query:type_name -> spaceone.api.core.v1.StatisticsQuery
	11, // 1: spaceone.api.statistics.v1.StatAggregateQuery.extend_data:type_name -> google.protobuf.Struct
	10, // 2: spaceone.api.statistics.v1.StatAggregateJoin.query:type_name -> spaceone.api.core.v1.StatisticsQuery
	...
	10, // 5: spaceone.api.statistics.v1.StatAggregateConcat.query:type_name -> spaceone.api.core.v1.StatisticsQuery
...
func file_spaceone_api_statistics_v1_resource_proto_init() {
	...
	file_spaceone_api_statistics_v1_resource_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*StatAggregateFormula_Eval)(nil),
		(*StatAggregateFormula_Query)(nil),
	}
	file_spaceone_api_statistics_v1_resource_proto_msgTypes[6].OneofWrappers = []interface{}{
