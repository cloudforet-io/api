...
_BUDGETUSAGEPROVIDERFILTER = DESCRIPTOR.message_types_by_name['BudgetUsageProviderFilter']
...
_BUDGETUSAGEANALYZEQUERY = DESCRIPTOR.message_types_by_name['BudgetUsageAnalyzeQuery']
_BUDGETUSAGESTATQUERY = DESCRIPTOR.message_types_by_name['BudgetUsageStatQuery']
_BUDGETUSAGEPROVIDERFILTER_STATE = _BUDGETUSAGEPROVIDERFILTER.enum_types_by_name['State']
BudgetUsageProviderFilter = _reflection.GeneratedProtocolMessageType('BudgetUsageProviderFilter', (_message.Message,), {
  'DESCRIPTOR' : _BUDGETUSAGEPROVIDERFILTER,
  '__module__' : 'spaceone.api.cost_analysis.v1.budget_usage_pb2'
  # @@protoc_insertion_point(class_scope:spaceone.api.cost_analysis.v1.BudgetUsageProviderFilter)
  })
_sym_db.RegisterMessage(BudgetUsageProviderFilter)
...
BudgetUsageAnalyzeQuery = _reflection.GeneratedProtocolMessageType('BudgetUsageAnalyzeQuery', (_message.Message,), {
  'DESCRIPTOR' : _BUDGETUSAGEANALYZEQUERY,
  '__module__' : 'spaceone.api.cost_analysis.v1.budget_usage_pb2'
  # @@protoc_insertion_point(class_scope:spaceone.api.cost_analysis.v1.BudgetUsageAnalyzeQuery)
  })
_sym_db.RegisterMessage(BudgetUsageAnalyzeQuery)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BUDGETUSAGEPROVIDERFILTER._serialized_start=178
  _BUDGETUSAGEPROVIDERFILTER._serialized_end=355
  _BUDGETUSAGEPROVIDERFILTER_STATE._serialized_start=305
  _BUDGETUSAGEPROVIDERFILTER_STATE._serialized_end=355
  _BUDGETUSAGEQUERY._serialized_start=358
  _BUDGETUSAGEQUERY._serialized_end=510
  _BUDGETUSAGEINFO._serialized_start=513
  _BUDGETUSAGEINFO._serialized_end=816
  _BUDGETUSAGESINFO._serialized_start=818
  _BUDGETUSAGESINFO._serialized_end=922
  _BUDGETUSAGEANALYZEQUERY._serialized_start=925
  _BUDGETUSAGEANALYZEQUERY._serialized_end=1073
  _BUDGETUSAGESTATQUERY._serialized_start=1076
  _BUDGETUSAGESTATQUERY._serialized_end=1214
  _BUDGETUSAGE._serialized_start=1217
  _BUDGETUSAGE._serialized_end=1664
