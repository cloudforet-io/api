...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/identity/v2/user_pb2_grpc.py depends on'
...
def add_UserServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.identity.v2.User', rpc_method_handlers)
