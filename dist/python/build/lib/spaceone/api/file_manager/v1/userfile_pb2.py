...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USERFILE'].methods_by_name['update']._serialized_options = b'\202\323\344\223\002%\" /file-manager/v1/userfile/update:\001*'
  _globals['_USERFILE'].methods_by_name['delete']._loaded_options = None
  _globals['_USERFILE'].methods_by_name['delete']._serialized_options = b'\202\323\344\223\002%\" /file-manager/v1/userfile/delete:\001*'
  _globals['_USERFILE'].methods_by_name['get']._loaded_options = None
  _globals['_USERFILE'].methods_by_name['get']._serialized_options = b'\202\323\344\223\002\"\"\035/file-manager/v1/userfile/get:\001*'
  _globals['_USERFILE'].methods_by_name['list']._loaded_options = None
  _globals['_USERFILE'].methods_by_name['list']._serialized_options = b'\202\323\344\223\002#\"\036/file-manager/v1/userfile/list:\001*'
  _globals['_USERFILE'].methods_by_name['stat']._loaded_options = None
  _globals['_USERFILE'].methods_by_name['stat']._serialized_options = b'\202\323\344\223\002#\"\036/file-manager/v1/userfile/stat:\001*'
  _globals['_USERFILEREFERENCE']._serialized_start=200
  _globals['_USERFILEREFERENCE']._serialized_end=263
  _globals['_CREATEUSERFILEREQUEST']._serialized_start=266
  _globals['_CREATEUSERFILEREQUEST']._serialized_end=446
  _globals['_UPDATEUSERFILEREQUEST']._serialized_start=449
  _globals['_UPDATEUSERFILEREQUEST']._serialized_end=596
  _globals['_USERFILEREQUEST']._serialized_start=598
  _globals['_USERFILEREQUEST']._serialized_end=632
  _globals['_USERFILESEARCHQUERY']._serialized_start=635
  _globals['_USERFILESEARCHQUERY']._serialized_end=811
  _globals['_USERFILEINFO']._serialized_start=814
  _globals['_USERFILEINFO']._serialized_end=1044
  _globals['_USERFILESINFO']._serialized_start=1046
  _globals['_USERFILESINFO']._serialized_end=1143
  _globals['_USERFILESTATQUERY']._serialized_start=1145
  _globals['_USERFILESTATQUERY']._serialized_end=1218
  _globals['_USERFILE']._serialized_start=1221
  _globals['_USERFILE']._serialized_end=1924
