...
from spaceone.api.alert_manager.v1 import alert_pb2 as spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/alert_manager/v1/alert_pb2_grpc.py depends on'
...
class AlertStub(object):
    ...
    def __init__(self, channel):
        ...
        self.export = channel.unary_unary(
                '/spaceone.api.alert_manager.v1.Alert/export',
                request_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertExportRequest.SerializeToString,
        ...
        self.stat = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertStatQuery.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_struct__pb2.Struct.FromString,
                _registered_method=True)
...
def add_AlertServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'export': grpc.unary_unary_rpc_method_handler(
                    servicer.export,
                    request_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertExportRequest.FromString,
            ...
            'stat': grpc.unary_unary_rpc_method_handler(
                    servicer.stat,
                    request_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertStatQuery.FromString,
                    response_serializer=google_dot_protobuf_dot_struct__pb2.Struct.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.alert_manager.v1.Alert', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('spaceone.api.alert_manager.v1.Alert', rpc_method_handlers)
...
class Alert(object):
    ...
    def export(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Alert/export',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertExportRequest.SerializeToString,
    ...
    def stat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Alert/stat',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_alert__pb2.AlertStatQuery.SerializeToString,
            google_dot_protobuf_dot_struct__pb2.Struct.FromString,
            options,
            channel_credentials,
            insecure,
