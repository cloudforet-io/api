...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/inventory/v1/cloud_service_report_pb2_grpc.py depends on'
...
def add_CloudServiceReportServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.inventory.v1.CloudServiceReport', rpc_method_handlers)
