...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/inventory/v1/metric_pb2_grpc.py depends on'
...
def add_MetricServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.inventory.v1.Metric', rpc_method_handlers)
