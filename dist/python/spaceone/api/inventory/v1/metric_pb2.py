...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_METRIC'].methods_by_name['create']._options = None
  _globals['_METRIC'].methods_by_name['create']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/create:\001*'
  _globals['_METRIC'].methods_by_name['update']._options = None
  _globals['_METRIC'].methods_by_name['update']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/update:\001*'
  _globals['_METRIC'].methods_by_name['delete']._options = None
  _globals['_METRIC'].methods_by_name['delete']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/delete:\001*'
  _globals['_METRIC'].methods_by_name['run']._options = None
  _globals['_METRIC'].methods_by_name['run']._serialized_options = b'\202\323\344\223\002\035\"\030/inventory/v1/metric/run:\001*'
  _globals['_METRIC'].methods_by_name['test']._options = None
  _globals['_METRIC'].methods_by_name['test']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/test:\001*'
  _globals['_METRIC'].methods_by_name['get']._options = None
  _globals['_METRIC'].methods_by_name['get']._serialized_options = b'\202\323\344\223\002\035\"\030/inventory/v1/metric/get:\001*'
  _globals['_METRIC'].methods_by_name['list']._options = None
  _globals['_METRIC'].methods_by_name['list']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/list:\001*'
  _globals['_METRIC'].methods_by_name['stat']._options = None
  _globals['_METRIC'].methods_by_name['stat']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/stat:\001*'
  _globals['_METRICTYPE']._serialized_start=1426
  _globals['_METRICTYPE']._serialized_end=1484
  _globals['_CREATEMETRICREQUEST']._serialized_start=193
  _globals['_CREATEMETRICREQUEST']._serialized_end=464
  _globals['_UPDATEMETRICREQUEST']._serialized_start=467
  _globals['_UPDATEMETRICREQUEST']._serialized_end=633
  _globals['_METRICREQUEST']._serialized_start=635
  _globals['_METRICREQUEST']._serialized_end=669
  _globals['_METRICQUERY']._serialized_start=672
  _globals['_METRICQUERY']._serialized_end=895
  _globals['_METRICINFO']._serialized_start=898
  _globals['_METRICINFO']._serialized_end=1259
  _globals['_METRICSINFO']._serialized_start=1261
  _globals['_METRICSINFO']._serialized_end=1351
  _globals['_METRICSTATQUERY']._serialized_start=1353
  _globals['_METRICSTATQUERY']._serialized_end=1424
  _globals['_METRIC']._serialized_start=1487
  _globals['_METRIC']._serialized_end=2476
