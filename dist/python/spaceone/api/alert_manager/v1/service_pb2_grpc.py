...
from spaceone.api.alert_manager.v1 import service_pb2 as spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/alert_manager/v1/service_pb2_grpc.py depends on'
...
class ServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceCreateRequest.SerializeToString,
        ...
        self.list = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceSearchQuery.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServicesInfo.FromString,
                _registered_method=True)
        self.stat = channel.unary_unary(
                '/spaceone.api.alert_manager.v1.Service/stat',
                request_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceStatQuery.SerializeToString,
...
def add_ServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'create': grpc.unary_unary_rpc_method_handler(
                    servicer.create,
                    request_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceCreateRequest.FromString,
            ...
            'list': grpc.unary_unary_rpc_method_handler(
                    servicer.list,
                    request_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceSearchQuery.FromString,
                    response_serializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServicesInfo.SerializeToString,
            ),
            'stat': grpc.unary_unary_rpc_method_handler(
                    servicer.stat,
                    request_deserializer=spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceStatQuery.FromString,
...
class Service(object):
    ...
    def create(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Service/create',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceCreateRequest.SerializeToString,
    ...
    def update(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Service/update',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceUpdateRequest.SerializeToString,
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceInfo.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def list(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Service/list',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceSearchQuery.SerializeToString,
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServicesInfo.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def stat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.alert_manager.v1.Service/stat',
            spaceone_dot_api_dot_alert__manager_dot_v1_dot_service__pb2.ServiceStatQuery.SerializeToString,
