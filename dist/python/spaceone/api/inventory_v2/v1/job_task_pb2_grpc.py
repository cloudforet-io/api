...
from spaceone.api.inventory_v2.v1 import job_task_pb2 as spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in spaceone/api/inventory_v2/v1/job_task_pb2_grpc.py depends on'
...
class JobTaskStub(object):
    ...
    def __init__(self, channel):
        ...
        self.delete = channel.unary_unary(
                '/spaceone.api.inventory_v2.v1.JobTask/delete',
        ...
        self.list = channel.unary_unary(
                ...
                response_deserializer=spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTasksInfo.FromString,
                _registered_method=True)
        self.stat = channel.unary_unary(
                '/spaceone.api.inventory_v2.v1.JobTask/stat',
                request_serializer=spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTaskStatQuery.SerializeToString,
...
def add_JobTaskServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'list': grpc.unary_unary_rpc_method_handler(
                    servicer.list,
                    request_deserializer=spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTaskQuery.FromString,
                    response_serializer=spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTasksInfo.SerializeToString,
            ),
            'stat': grpc.unary_unary_rpc_method_handler(
                    servicer.stat,
                    request_deserializer=spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTaskStatQuery.FromString,
                    response_serializer=google_dot_protobuf_dot_struct__pb2.Struct.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.inventory_v2.v1.JobTask', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('spaceone.api.inventory_v2.v1.JobTask', rpc_method_handlers)
...
class JobTask(object):
    ...
    def list(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.inventory_v2.v1.JobTask/list',
            spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTaskQuery.SerializeToString,
            spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTasksInfo.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def stat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spaceone.api.inventory_v2.v1.JobTask/stat',
            spaceone_dot_api_dot_inventory__v2_dot_v1_dot_job__task__pb2.JobTaskStatQuery.SerializeToString,
