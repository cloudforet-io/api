...
func request_History_Create_0(ctx context.Context, marshaler runtime.Marshaler, client HistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_History_Create_0(ctx context.Context, marshaler runtime.Marshaler, server HistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateHistoryRequest
	var metadata runtime.ServerMetadata
...
func request_History_List_0(ctx context.Context, marshaler runtime.Marshaler, client HistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_History_List_0(ctx context.Context, marshaler runtime.Marshaler, server HistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryHistoryRequest
	var metadata runtime.ServerMetadata
...
func request_History_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client HistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HistoryStatRequest
	var metadata runtime.ServerMetadata
...
func local_request_History_Stat_0(ctx context.Context, marshaler runtime.Marshaler, server HistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HistoryStatRequest
	var metadata runtime.ServerMetadata
...
func RegisterHistoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HistoryServer) error {
...
func RegisterHistoryHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterHistoryHandlerClient(ctx, mux, NewHistoryClient(conn))
}

// RegisterHistoryHandlerClient registers the http handlers for service History
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "HistoryClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "HistoryClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "HistoryClient" to call the correct interceptors.
func RegisterHistoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HistoryClient) error {
