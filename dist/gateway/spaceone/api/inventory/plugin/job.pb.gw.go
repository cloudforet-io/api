...
func request_Job_GetTasks_0(ctx context.Context, marshaler runtime.Marshaler, client extPlugin.JobClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extPlugin.GetTaskRequest
...
func RegisterJobHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extPlugin.JobServer) error {
	mux.Handle(http.MethodPost, pattern_Job_GetTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.inventory.plugin.Job/GetTasks", runtime.WithHTTPPathPattern("/spaceone.api.inventory.plugin.Job/get_tasks"))
		if err != nil {
...
func RegisterJobHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extPlugin.JobClient) error {
	mux.Handle(http.MethodPost, pattern_Job_GetTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.inventory.plugin.Job/GetTasks", runtime.WithHTTPPathPattern("/spaceone.api.inventory.plugin.Job/get_tasks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Job_GetTasks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spaceone.api.inventory.plugin.Job", "get_tasks"}, ""))
)
