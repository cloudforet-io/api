...
func request_Collector_Init_0(ctx context.Context, marshaler runtime.Marshaler, client CollectorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Collector_Init_0(ctx context.Context, marshaler runtime.Marshaler, server CollectorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InitRequest
	var metadata runtime.ServerMetadata
...
func request_Collector_Verify_0(ctx context.Context, marshaler runtime.Marshaler, client CollectorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Collector_Verify_0(ctx context.Context, marshaler runtime.Marshaler, server CollectorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq VerifyRequest
	var metadata runtime.ServerMetadata
...
func request_Collector_Collect_0(ctx context.Context, marshaler runtime.Marshaler, client CollectorClient, req *http.Request, pathParams map[string]string) (Collector_CollectClient, runtime.ServerMetadata, error) {
