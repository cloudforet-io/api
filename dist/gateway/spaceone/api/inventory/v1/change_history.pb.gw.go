...
func request_ChangeHistory_List_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.ChangeHistoryQuery
...
func request_ChangeHistory_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.ChangeHistoryStatQuery
		metadata runtime.ServerMetadata
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
...
func RegisterChangeHistoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.ChangeHistoryServer) error {
	mux.Handle(http.MethodPost, pattern_ChangeHistory_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodPost, pattern_ChangeHistory_Stat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "extV1.ChangeHistoryClient" to call the correct interceptors. This client ignores the HTTP middlewares.
