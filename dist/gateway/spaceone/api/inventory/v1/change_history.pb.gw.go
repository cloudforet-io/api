...
func request_ChangeHistory_List_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ChangeHistoryQuery
...
func local_request_ChangeHistory_List_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ChangeHistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ChangeHistoryQuery
	var metadata runtime.ServerMetadata
...
func request_ChangeHistory_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ChangeHistoryStatQuery
	var metadata runtime.ServerMetadata
...
func local_request_ChangeHistory_Stat_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ChangeHistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ChangeHistoryStatQuery
	var metadata runtime.ServerMetadata
...
func RegisterChangeHistoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server v1_0.ChangeHistoryServer) error {
...
func RegisterChangeHistoryHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterChangeHistoryHandlerClient(ctx, mux, v1_0.NewChangeHistoryClient(conn))
}

// RegisterChangeHistoryHandlerClient registers the http handlers for service ChangeHistory
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "v1_0.ChangeHistoryClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "v1_0.ChangeHistoryClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "v1_0.ChangeHistoryClient" to call the correct interceptors.
func RegisterChangeHistoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client v1_0.ChangeHistoryClient) error {
