...
func request_Job_Delete_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.JobClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Job_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.JobServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.JobRequest
	var metadata runtime.ServerMetadata
...
func request_Job_Analyze_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.JobClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.JobAnalyzeQuery
	var metadata runtime.ServerMetadata
...
func local_request_Job_Analyze_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.JobServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.JobAnalyzeQuery
	var metadata runtime.ServerMetadata
