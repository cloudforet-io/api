...
func RegisterProtocolHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extPlugin.ProtocolServer) error {
	mux.Handle(http.MethodPost, pattern_Protocol_Init_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.alert_manager.plugin.Protocol/Init", runtime.WithHTTPPathPattern("/spaceone.api.alert_manager.plugin.Protocol/init"))
		if err != nil {
	...
	mux.Handle(http.MethodPost, pattern_Protocol_Verify_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.alert_manager.plugin.Protocol/Verify", runtime.WithHTTPPathPattern("/spaceone.api.alert_manager.plugin.Protocol/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterProtocolHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extPlugin.ProtocolClient) error {
	mux.Handle(http.MethodPost, pattern_Protocol_Init_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.alert_manager.plugin.Protocol/Init", runtime.WithHTTPPathPattern("/spaceone.api.alert_manager.plugin.Protocol/init"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_Protocol_Verify_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.alert_manager.plugin.Protocol/Verify", runtime.WithHTTPPathPattern("/spaceone.api.alert_manager.plugin.Protocol/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Protocol_Init_0   = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spaceone.api.alert_manager.plugin.Protocol", "init"}, ""))
	pattern_Protocol_Verify_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spaceone.api.alert_manager.plugin.Protocol", "verify"}, ""))
)
