...
func request_Event_Create_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.EventClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.EventCreateRequest
...
func RegisterEventHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.EventServer) error {
	mux.Handle(http.MethodPost, pattern_Event_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.alert_manager.v1.Event/Create", runtime.WithHTTPPathPattern("/alert-manager/v1/comment/create"))
		if err != nil {
...
func RegisterEventHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV1.EventClient) error {
	mux.Handle(http.MethodPost, pattern_Event_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.alert_manager.v1.Event/Create", runtime.WithHTTPPathPattern("/alert-manager/v1/comment/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Event_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"alert-manager", "v1", "comment", "create"}, ""))
)
