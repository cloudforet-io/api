...
func request_Cost_GetData_0(ctx context.Context, marshaler runtime.Marshaler, client CostClient, req *http.Request, pathParams map[string]string) (Cost_GetDataClient, runtime.ServerMetadata, error) {
