...
func local_request_Schedule_Create_0(ctx context.Context, marshaler runtime.Marshaler, server ScheduleServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateScheduleRequest
	var metadata runtime.ServerMetadata
