...
func request_BudgetUsage_List_0(ctx context.Context, marshaler runtime.Marshaler, client BudgetUsageClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageQuery
...
func local_request_BudgetUsage_List_0(ctx context.Context, marshaler runtime.Marshaler, server BudgetUsageServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageQuery
	var metadata runtime.ServerMetadata
...
func request_BudgetUsage_Analyze_0(ctx context.Context, marshaler runtime.Marshaler, client BudgetUsageClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageAnalyzeQuery
	var metadata runtime.ServerMetadata
...
func local_request_BudgetUsage_Analyze_0(ctx context.Context, marshaler runtime.Marshaler, server BudgetUsageServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageAnalyzeQuery
	var metadata runtime.ServerMetadata
...
func request_BudgetUsage_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client BudgetUsageClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageStatQuery
	var metadata runtime.ServerMetadata
...
func local_request_BudgetUsage_Stat_0(ctx context.Context, marshaler runtime.Marshaler, server BudgetUsageServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BudgetUsageStatQuery
	var metadata runtime.ServerMetadata
...
func RegisterBudgetUsageHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BudgetUsageServer) error {
...
func RegisterBudgetUsageHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterBudgetUsageHandlerClient(ctx, mux, NewBudgetUsageClient(conn))
}

// RegisterBudgetUsageHandlerClient registers the http handlers for service BudgetUsage
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "BudgetUsageClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "BudgetUsageClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "BudgetUsageClient" to call the correct interceptors.
func RegisterBudgetUsageHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BudgetUsageClient) error {
