...
func request_UnifiedCost_Run_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.UnifiedCostClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.UnifiedCostRunRequest
...
func local_request_UnifiedCost_Run_0(ctx context.Context, marshaler runtime.Marshaler, server extV1.UnifiedCostServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.UnifiedCostRunRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterUnifiedCostHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.UnifiedCostServer) error {
	mux.Handle(http.MethodPost, pattern_UnifiedCost_Run_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.cost_analysis.v1.UnifiedCost/Run", runtime.WithHTTPPathPattern("/spaceone.api.cost_analysis.v1.UnifiedCost/run"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UnifiedCost_Run_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_UnifiedCost_Run_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterUnifiedCostHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV1.UnifiedCostClient) error {
	mux.Handle(http.MethodPost, pattern_UnifiedCost_Run_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.cost_analysis.v1.UnifiedCost/Run", runtime.WithHTTPPathPattern("/spaceone.api.cost_analysis.v1.UnifiedCost/run"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UnifiedCost_Run_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UnifiedCost_Run_0     = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spaceone.api.cost_analysis.v1.UnifiedCost", "run"}, ""))
...
var (
	forward_UnifiedCost_Run_0     = runtime.ForwardResponseMessage
