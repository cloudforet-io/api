...
func request_Endpoint_List_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.EndpointClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq v1_0.EndpointQuery
...
func local_request_Endpoint_List_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.EndpointServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq v1_0.EndpointQuery
		metadata runtime.ServerMetadata
	)
...
func RegisterEndpointHandlerServer(ctx context.Context, mux *runtime.ServeMux, server v1_0.EndpointServer) error {
	mux.Handle(http.MethodPost, pattern_Endpoint_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.identity.v1.Endpoint/List", runtime.WithHTTPPathPattern("/identity/v1/endpoint/list"))
		if err != nil {
...
func RegisterEndpointHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterEndpointHandlerClient(ctx, mux, v1_0.NewEndpointClient(conn))
}

// RegisterEndpointHandlerClient registers the http handlers for service Endpoint
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "v1_0.EndpointClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "v1_0.EndpointClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "v1_0.EndpointClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterEndpointHandlerClient(ctx context.Context, mux *runtime.ServeMux, client v1_0.EndpointClient) error {
	mux.Handle(http.MethodPost, pattern_Endpoint_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.identity.v1.Endpoint/List", runtime.WithHTTPPathPattern("/identity/v1/endpoint/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Endpoint_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"identity", "v1", "endpoint", "list"}, ""))
)
