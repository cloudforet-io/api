...
func request_ServiceAccount_ChangeTrustedServiceAccount_0(ctx context.Context, marshaler runtime.Marshaler, client extV2.ServiceAccountClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.ChangeTrustedServiceAccount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ServiceAccount_ChangeTrustedServiceAccount_0(ctx context.Context, marshaler runtime.Marshaler, server extV2.ServiceAccountServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV2.ChangeTrustedAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ChangeTrustedServiceAccount(ctx, &protoReq)
	return msg, metadata, err

}

func request_ServiceAccount_ChangeProject_0(ctx context.Context, marshaler runtime.Marshaler, client extV2.ServiceAccountClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV2.ChangeProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ChangeProject(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ServiceAccount_ChangeProject_0(ctx context.Context, marshaler runtime.Marshaler, server extV2.ServiceAccountServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV2.ChangeProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ChangeProject(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterServiceAccountHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV2.ServiceAccountServer) error {
	...
	mux.Handle("POST", pattern_ServiceAccount_ChangeTrustedServiceAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.identity.v2.ServiceAccount/ChangeTrustedServiceAccount", runtime.WithHTTPPathPattern("/identity/v2/service-account/change-trusted-service-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ServiceAccount_ChangeTrustedServiceAccount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ServiceAccount_ChangeTrustedServiceAccount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ServiceAccount_ChangeProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.identity.v2.ServiceAccount/ChangeProject", runtime.WithHTTPPathPattern("/identity/v2/service-account/change-project"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ServiceAccount_ChangeProject_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ServiceAccount_ChangeProject_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterServiceAccountHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV2.ServiceAccountClient) error {
	...
	mux.Handle("POST", pattern_ServiceAccount_ChangeTrustedServiceAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.identity.v2.ServiceAccount/ChangeTrustedServiceAccount", runtime.WithHTTPPathPattern("/identity/v2/service-account/change-trusted-service-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ServiceAccount_ChangeTrustedServiceAccount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ServiceAccount_ChangeProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.identity.v2.ServiceAccount/ChangeProject", runtime.WithHTTPPathPattern("/identity/v2/service-account/change-project"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ServiceAccount_ChangeProject_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ServiceAccount_ChangeTrustedServiceAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"identity", "v2", "service-account", "change-trusted-service-account"}, ""))

	pattern_ServiceAccount_ChangeProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"identity", "v2", "service-account", "change-project"}, ""))
...
var (
	...
	forward_ServiceAccount_ChangeTrustedServiceAccount_0 = runtime.ForwardResponseMessage

	forward_ServiceAccount_ChangeProject_0 = runtime.ForwardResponseMessage
