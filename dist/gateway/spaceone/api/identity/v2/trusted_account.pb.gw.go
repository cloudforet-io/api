...
func request_TrustedAccount_UpdateSecret_0(ctx context.Context, marshaler runtime.Marshaler, client v2_0.TrustedAccountClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_TrustedAccount_UpdateSecret_0(ctx context.Context, marshaler runtime.Marshaler, server v2_0.TrustedAccountServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v2_0.UpdateTrustedAccountSecretRequest
	var metadata runtime.ServerMetadata
...
func RegisterTrustedAccountHandlerServer(ctx context.Context, mux *runtime.ServeMux, server v2_0.TrustedAccountServer) error {
	...
	mux.Handle("POST", pattern_TrustedAccount_UpdateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.identity.v2.TrustedAccount/UpdateSecret", runtime.WithHTTPPathPattern("/identity/v2/trusted-account/update-secret-data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TrustedAccount_UpdateSecret_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TrustedAccount_UpdateSecret_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTrustedAccountHandlerClient(ctx context.Context, mux *runtime.ServeMux, client v2_0.TrustedAccountClient) error {
	...
	mux.Handle("POST", pattern_TrustedAccount_UpdateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.identity.v2.TrustedAccount/UpdateSecret", runtime.WithHTTPPathPattern("/identity/v2/trusted-account/update-secret-data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TrustedAccount_UpdateSecret_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TrustedAccount_UpdateSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"identity", "v2", "trusted-account", "update-secret-data"}, ""))
...
var (
	...
	forward_TrustedAccount_UpdateSecret_0 = runtime.ForwardResponseMessage
