...
func request_APIKey_Verify_0(ctx context.Context, marshaler runtime.Marshaler, client extV2.APIKeyClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV2.VerifyAPIKeyRequest
	var metadata runtime.ServerMetadata
...
func local_request_APIKey_Verify_0(ctx context.Context, marshaler runtime.Marshaler, server extV2.APIKeyServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV2.VerifyAPIKeyRequest
	var metadata runtime.ServerMetadata
...
func RegisterAPIKeyHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV2.APIKeyServer) error {
	...
	mux.Handle("POST", pattern_APIKey_Verify_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.identity.v2.APIKey/Verify", runtime.WithHTTPPathPattern("/spaceone.api.identity.v2.APIKey/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_APIKey_Verify_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_APIKey_Verify_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAPIKeyHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV2.APIKeyClient) error {
	...
	mux.Handle("POST", pattern_APIKey_Verify_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.identity.v2.APIKey/Verify", runtime.WithHTTPPathPattern("/spaceone.api.identity.v2.APIKey/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_APIKey_Verify_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_APIKey_Verify_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spaceone.api.identity.v2.APIKey", "verify"}, ""))
...
var (
	...
	forward_APIKey_Verify_0 = runtime.ForwardResponseMessage
