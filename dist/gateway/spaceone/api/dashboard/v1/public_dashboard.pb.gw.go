...
func request_PublicDashboard_ChangeFolder_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.PublicDashboardClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV1.ChangeFolderPublicDashboardRequest
	var metadata runtime.ServerMetadata
...
func RegisterPublicDashboardHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.PublicDashboardServer) error {
	...
	mux.Handle("POST", pattern_PublicDashboard_ChangeFolder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
