...
func request_Repository_List_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.RepositoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.RepositoryQuery
...
func local_request_Repository_List_0(ctx context.Context, marshaler runtime.Marshaler, server extV1.RepositoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.RepositoryQuery
		metadata runtime.ServerMetadata
	)
...
func RegisterRepositoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.RepositoryServer) error {
	mux.Handle(http.MethodPost, pattern_Repository_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterRepositoryHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterRepositoryHandlerClient(ctx, mux, extV1.NewRepositoryClient(conn))
}

// RegisterRepositoryHandlerClient registers the http handlers for service Repository
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extV1.RepositoryClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extV1.RepositoryClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extV1.RepositoryClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterRepositoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV1.RepositoryClient) error {
	mux.Handle(http.MethodPost, pattern_Repository_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
