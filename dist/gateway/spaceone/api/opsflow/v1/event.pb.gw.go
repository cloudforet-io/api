...
func request_Event_List_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.EventClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extV1.EventSearchQuery
...
func RegisterEventHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.EventServer) error {
	mux.Handle(http.MethodPost, pattern_Event_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.opsflow.v1.Event/List", runtime.WithHTTPPathPattern("/opsflow/v1/event/list"))
		if err != nil {
	...
	mux.Handle(http.MethodPost, pattern_Event_Stat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.opsflow.v1.Event/Stat", runtime.WithHTTPPathPattern("/opsflow/v1/event/stat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterEventHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV1.EventClient) error {
	mux.Handle(http.MethodPost, pattern_Event_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.opsflow.v1.Event/List", runtime.WithHTTPPathPattern("/opsflow/v1/event/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_Event_Stat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.opsflow.v1.Event/Stat", runtime.WithHTTPPathPattern("/opsflow/v1/event/stat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Event_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"opsflow", "v1", "event", "list"}, ""))
	pattern_Event_Stat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"opsflow", "v1", "event", "stat"}, ""))
)
