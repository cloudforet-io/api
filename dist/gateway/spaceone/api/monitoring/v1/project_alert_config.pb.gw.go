...
func request_ProjectAlertConfig_Create_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ProjectAlertConfigClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.CreateProjectAlertConfigRequest
...
func local_request_ProjectAlertConfig_Create_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ProjectAlertConfigServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.CreateProjectAlertConfigRequest
	var metadata runtime.ServerMetadata
...
func request_ProjectAlertConfig_Update_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ProjectAlertConfigClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.UpdateProjectAlertConfigRequest
	var metadata runtime.ServerMetadata
...
func local_request_ProjectAlertConfig_Update_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ProjectAlertConfigServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.UpdateProjectAlertConfigRequest
	var metadata runtime.ServerMetadata
...
func request_ProjectAlertConfig_Delete_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ProjectAlertConfigClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ProjectAlertConfig_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ProjectAlertConfigServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ProjectAlertConfigRequest
	var metadata runtime.ServerMetadata
...
func request_ProjectAlertConfig_List_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ProjectAlertConfigClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ProjectAlertConfigQuery
	var metadata runtime.ServerMetadata
...
func local_request_ProjectAlertConfig_List_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ProjectAlertConfigServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ProjectAlertConfigQuery
	var metadata runtime.ServerMetadata
...
func request_ProjectAlertConfig_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client v1_0.ProjectAlertConfigClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ProjectAlertConfigStatQuery
	var metadata runtime.ServerMetadata
...
func local_request_ProjectAlertConfig_Stat_0(ctx context.Context, marshaler runtime.Marshaler, server v1_0.ProjectAlertConfigServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.ProjectAlertConfigStatQuery
	var metadata runtime.ServerMetadata
...
func RegisterProjectAlertConfigHandlerServer(ctx context.Context, mux *runtime.ServeMux, server v1_0.ProjectAlertConfigServer) error {
...
func RegisterProjectAlertConfigHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterProjectAlertConfigHandlerClient(ctx, mux, v1_0.NewProjectAlertConfigClient(conn))
}

// RegisterProjectAlertConfigHandlerClient registers the http handlers for service ProjectAlertConfig
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "v1_0.ProjectAlertConfigClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "v1_0.ProjectAlertConfigClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "v1_0.ProjectAlertConfigClient" to call the correct interceptors.
func RegisterProjectAlertConfigHandlerClient(ctx context.Context, mux *runtime.ServeMux, client v1_0.ProjectAlertConfigClient) error {
